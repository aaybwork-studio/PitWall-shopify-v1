 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(B,X){var Z=B.length;B.push(X);e:for(;0<Z;){var te=Z-1>>>1,re=B[te];if(0<r(re,X))B[te]=X,B[Z]=re,Z=te;else break e}}function t(B){return B.length===0?null:B[0]}function i(B){if(B.length===0)return null;var X=B[0],Z=B.pop();if(Z!==X){B[0]=Z;e:for(var te=0,re=B.length,Ce=re>>>1;te<Ce;){var oe=2*(te+1)-1,xe=B[oe],Y=oe+1,ae=B[Y];if(0>r(xe,Z))Y<re&&0>r(ae,xe)?(B[te]=ae,B[Y]=Z,te=Y):(B[te]=xe,B[oe]=Z,te=oe);else if(Y<re&&0>r(ae,Z))B[te]=ae,B[Y]=Z,te=Y;else break e}}return X}function r(B,X){var Z=B.sortIndex-X.sortIndex;return Z!==0?Z:B.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],c=[],u=1,d=null,f=3,p=!1,m=!1,y=!1,g=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(B){for(var X=t(c);X!==null;){if(X.callback===null)i(c);else if(X.startTime<=B)i(c),X.sortIndex=X.expirationTime,e(l,X);else break;X=t(c)}}function M(B){if(y=!1,v(B),!m)if(t(l)!==null)m=!0,U(b);else{var X=t(c);X!==null&&O(M,X.startTime-B)}}function b(B,X){m=!1,y&&(y=!1,h(x),x=-1),p=!0;var Z=f;try{for(v(X),d=t(l);d!==null&&(!(d.expirationTime>X)||B&&!C());){var te=d.callback;if(typeof te=="function"){d.callback=null,f=d.priorityLevel;var re=te(d.expirationTime<=X);X=n.unstable_now(),typeof re=="function"?d.callback=re:d===t(l)&&i(l),v(X)}else i(l);d=t(l)}if(d!==null)var Ce=!0;else{var oe=t(c);oe!==null&&O(M,oe.startTime-X),Ce=!1}return Ce}finally{d=null,f=Z,p=!1}}var T=!1,A=null,x=-1,R=5,P=-1;function C(){return!(n.unstable_now()-P<R)}function F(){if(A!==null){var B=n.unstable_now();P=B;var X=!0;try{X=A(!0,B)}finally{X?W():(T=!1,A=null)}}else T=!1}var W;if(typeof _=="function")W=function(){_(F)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,L=K.port2;K.port1.onmessage=F,W=function(){L.postMessage(null)}}else W=function(){g(F,0)};function U(B){A=B,T||(T=!0,W())}function O(B,X){x=g(function(){B(n.unstable_now())},X)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(B){B.callback=null},n.unstable_continueExecution=function(){m||p||(m=!0,U(b))},n.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<B?Math.floor(1e3/B):5},n.unstable_getCurrentPriorityLevel=function(){return f},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(B){switch(f){case 1:case 2:case 3:var X=3;break;default:X=f}var Z=f;f=X;try{return B()}finally{f=Z}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(B,X){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var Z=f;f=B;try{return X()}finally{f=Z}},n.unstable_scheduleCallback=function(B,X,Z){var te=n.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?te+Z:te):Z=te,B){case 1:var re=-1;break;case 2:re=250;break;case 5:re=1073741823;break;case 4:re=1e4;break;default:re=5e3}return re=Z+re,B={id:u++,callback:X,priorityLevel:B,startTime:Z,expirationTime:re,sortIndex:-1},Z>te?(B.sortIndex=Z,e(c,B),t(l)===null&&B===t(c)&&(y?(h(x),x=-1):y=!0,O(M,Z-te))):(B.sortIndex=re,e(l,B),m||p||(m=!0,U(b))),B},n.unstable_shouldYield=C,n.unstable_wrapCallback=function(B){var X=f;return function(){var Z=f;f=X;try{return B.apply(this,arguments)}finally{f=Z}}}})(x0);v0.exports=x0;var Vx=v0.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Nr=(n,e)=>{const t=De.forwardRef(({className:i,...r},s)=>De.createElement(KS,{ref:s,iconNode:e,className:vv(`lucide-${jS(n)}`,i),...r}));return t.displayName=`${n}`,t};/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function hA(n,e,t){const i=new Float32Array(Gr),r=new k(0,1,0);return new Ei({name:"SphericalGaussianBlur",defines:{n:Gr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Yc(),fragmentShader:`
...
`)}const vb={[Sv]:"Linear",[Mv]:"Reinhard",[Ev]:"Cineon",[Tv]:"ACESFilmic",[Av]:"AgX",[bv]:"Neutral",[wv]:"Custom"};function xb(n,e){const t=vb[e];return t===void 0?(be("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Tl=new k;function yb(){Ye.getLuminanceCoefficients(Tl);const n=Tl.x.toFixed(4),e=Tl.y.toFixed(4),t=Tl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+h);const v=_+g+o,M=_+h+a,b=Hg(r,r.VERTEX_SHADER,v),T=Hg(r,r.FRAGMENT_SHADER,M);r.attachShader(y,b),r.attachShader(y,T),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function A(C){if(n.debug.checkShaderErrors){const F=r.getProgramInfoLog(y)||"",W=r.getShaderInfoLog(b)||"",K=r.getShaderInfoLog(T)||"",L=F.trim(),U=W.trim(),O=K.trim();let B=!0,X=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(B=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,y,b,T);else{const Z=Wg(r,b,"vertex"),te=Wg(r,T,"fragment");Ue("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
}`,tR=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],nR=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],Jg=new We,Fo=new k,sf=new k;function iR(n,e,t){let i=new ap;const r=new Je,s=new Je,o=new ft,a=new VE,l=new HE,c={},u=t.maxTextureSize,d={[Yi]:vn,[vn]:Yi,[pi]:pi},f=new Ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Je},radius:{value:4}},vertexShader:Qb,fragmentShader:eR}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const m=new Gn;m.setAttribute("position",new un(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new Cn(m,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Bl;let h=this.type;this.render=function(T,A,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||T.length===0)return;this.type===xv&&(be("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Bl);const R=n.getRenderTarget(),P=n.getActiveCubeFace(),C=n.getActiveMipmapLevel(),F=n.state;F.setBlending(Vi),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const W=h!==this.type;W&&A.traverse(function(K){K.material&&(Array.isArray(K.material)?K.material.forEach(L=>L.needsUpdate=!0):K.material.needsUpdate=!0)});for(let K=0,L=T.length;K<L;K++){const U=T[K],O=U.shadow;if(O===void 0){be("WebGLShadowMap:",U,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;r.copy(O.mapSize);const B=O.getFrameExtents();r.multiply(B),s.copy(O.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/B.x),r.x=s.x*B.x,O.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/B.y),r.y=s.y*B.y,O.mapSize.y=s.y));const X=n.state.buffers.depth.getReversed();if(O.camera._reversedDepth=X,O.map===null||W===!0){if(O.map!==null&&(O.map.depthTexture!==null&&(O.map.depthTexture.dispose(),O.map.depthTexture=null),O.map.dispose()),this.type===Ho){if(U.isPointLight){be("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}O.map=new yi(r.x,r.y,{format:is,type:Ki,minFilter:zt,magFilter:zt,generateMipmaps:!1}),O.map.texture.name=U.name+".shadowMap",O.map.depthTexture=new so(r.x,r.y,kn),O.map.depthTexture.name=U.name+".shadowMapDepth",O.map.depthTexture.format=qi,O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Bt,O.map.depthTexture.magFilter=Bt}else U.isPointLight?(O.map=new tx(r.x),O.map.depthTexture=new UE(r.x,Mi)):(O.map=new yi(r.x,r.y),O.map.depthTexture=new so(r.x,r.y,Mi)),O.map.depthTexture.name=U.name+".shadowMap",O.map.depthTexture.format=qi,this.type===Bl?(O.map.depthTexture.compareFunction=X?tp:ep,O.map.depthTexture.minFilter=zt,O.map.depthTexture.magFilter=zt):(O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Bt,O.map.depthTexture.magFilter=Bt);O.camera.updateProjectionMatrix()}const Z=O.map.isWebGLCubeRenderTarget?6:1;for(let te=0;te<Z;te++){if(O.map.isWebGLCubeRenderTarget)n.setRenderTarget(O.map,te),n.clear();else{te===0&&(n.setRenderTarget(O.map),n.clear());const re=O.getViewport(te);o.set(s.x*re.x,s.y*re.y,s.x*re.z,s.y*re.w),F.viewport(o)}if(U.isPointLight){const re=O.camera,Ce=O.matrix,oe=U.distance||re.far;oe!==re.far&&(re.far=oe,re.updateProjectionMatrix()),Fo.setFromMatrixPosition(U.matrixWorld),re.position.copy(Fo),sf.copy(re.position),sf.add(tR[te]),re.up.copy(nR[te]),re.lookAt(sf),re.updateMatrixWorld(),Ce.makeTranslation(-Fo.x,-Fo.y,-Fo.z),Jg.multiplyMatrices(re.projectionMatrix,re.matrixWorldInverse),O._frustum.setFromProjectionMatrix(Jg,re.coordinateSystem,re.reversedDepth)}else O.updateMatrices(U);i=O.getFrustum(),M(A,x,O.camera,U,this.type)}O.isPointLightShadow!==!0&&this.type===Ho&&_(O,x),O.needsUpdate=!1}h=this.type,g.needsUpdate=!1,n.setRenderTarget(R,P,C)};function _(T,A){const x=e.update(y);f.defines.VSM_SAMPLES!==T.blurSamples&&(f.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new yi(r.x,r.y,{format:is,type:Ki})),f.uniforms.shadow_pass.value=T.map.depthTexture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(A,null,x,f,y,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(A,null,x,p,y,null)}function v(T,A,x,R){let P=null;const C=x.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(C!==void 0)P=C;else if(P=x.isPointLight===!0?l:a,n.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const F=P.uuid,W=A.uuid;let K=c[F];K===void 0&&(K={},c[F]=K);let L=K[W];L===void 0&&(L=P.clone(),K[W]=L,A.addEventListener("dispose",b)),P=L}if(P.visible=A.visible,P.wireframe=A.wireframe,R===Ho?P.side=A.shadowSide!==null?A.shadowSide:A.side:P.side=A.shadowSide!==null?A.shadowSide:d[A.side],P.alphaMap=A.alphaMap,P.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,P.map=A.map,P.clipShadows=A.clipShadows,P.clippingPlanes=A.clippingPlanes,P.clipIntersection=A.clipIntersection,P.displacementMap=A.displacementMap,P.displacementScale=A.displacementScale,P.displacementBias=A.displacementBias,P.wireframeLinewidth=A.wireframeLinewidth,P.linewidth=A.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const F=n.properties.get(P);F.light=x}return P}function M(T,A,x,R,P){if(T.visible===!1)return;if(T.layers.test(A.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&P===Ho)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,T.matrixWorld);const W=e.update(T),K=T.material;if(Array.isArray(K)){const L=W.groups;for(let U=0,O=L.length;U<O;U++){const B=L[U],X=K[B.materialIndex];if(X&&X.visible){const Z=v(T,X,R,P);T.onBeforeShadow(n,T,A,x,W,Z,B),n.renderBufferDirect(x,null,W,Z,T,B),T.onAfterShadow(n,T,A,x,W,Z,B)}}}else if(K.visible){const L=v(T,K,R,P);T.onBeforeShadow(n,T,A,x,W,L,null),n.renderBufferDirect(x,null,W,L,T,null),T.onAfterShadow(n,T,A,x,W,L,null)}}const F=T.children;for(let W=0,K=F.length;W<K;W++)M(F[W],A,x,R,P)}function b(T){T.target.removeEventListener("dispose",b);for(const x in c){const R=c[x],P=T.target.uuid;P in R&&(R[P].dispose(),delete R[P])}}}function rR(n,e){function t(){let N=!1;const ue=new ft;let $=null;const ye=new ft(0,0,0,0);return{setMask:function(de){$!==de&&!N&&(n.colorMask(de,de,de,de),$=de)},setLocked:function(de){N=de},setClear:function(de,ee,Re,Be,Rt){Rt===!0&&(de*=Be,ee*=Be,Re*=Be),ue.set(de,ee,Re,Be),ye.equals(ue)===!1&&(n.clearColor(de,ee,Re,Be),ye.copy(ue))},reset:function(){N=!1,$=null,ye.set(-1,0,0,0)}}}function i(){let N=!1,ue=!1,$=null,ye=null,de=null;return{setReversed:function(ee){if(ue!==ee){const Re=e.get("EXT_clip_control");ee?Re.clipControlEXT(Re.LOWER_LEFT_EXT,Re.ZERO_TO_ONE_EXT):Re.clipControlEXT(Re.LOWER_LEFT_EXT,Re.NEGATIVE_ONE_TO_ONE_EXT),ue=ee;const Be=de;de=null,this.setClear(Be)}},getReversed:function(){return ue},setTest:function(ee){ee?se(n.DEPTH_TEST):we(n.DEPTH_TEST)},setMask:function(ee){$!==ee&&!N&&(n.depthMask(ee),$=ee)},setFunc:function(ee){if(ue&&(ee=zM[ee]),ye!==ee){switch(ee){case sd:n.depthFunc(n.NEVER);break;case od:n.depthFunc(n.ALWAYS);break;case ad:n.depthFunc(n.LESS);break;case to:n.depthFunc(n.LEQUAL);break;case ld:n.depthFunc(n.EQUAL);break;case cd:n.depthFunc(n.GEQUAL);break;case ud:n.depthFunc(n.GREATER);break;case fd:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ye=ee}},setLocked:function(ee){N=ee},setClear:function(ee){de!==ee&&(de=ee,ue&&(ee=1-ee),n.clearDepth(ee))},reset:function(){N=!1,$=null,ye=null,de=null,ue=!1}}}function r(){let N=!1,ue=null,$=null,ye=null,de=null,ee=null,Re=null,Be=null,Rt=null;return{setTest:function(at){N||(at?se(n.STENCIL_TEST):we(n.STENCIL_TEST))},setMask:function(at){ue!==at&&!N&&(n.stencilMask(at),ue=at)},setFunc:function(at,bi,si){($!==at||ye!==bi||de!==si)&&(n.stencilFunc(at,bi,si),$=at,ye=bi,de=si)},setOp:function(at,bi,si){(ee!==at||Re!==bi||Be!==si)&&(n.stencilOp(at,bi,si),ee=at,Re=bi,Be=si)},setLocked:function(at){N=at},setClear:function(at){Rt!==at&&(n.clearStencil(at),Rt=at)},reset:function(){N=!1,ue=null,$=null,ye=null,de=null,ee=null,Re=null,Be=null,Rt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},d={},f={},p=new WeakMap,m=[],y=null,g=!1,h=null,_=null,v=null,M=null,b=null,T=null,A=null,x=new ke(0,0,0),R=0,P=!1,C=null,F=null,W=null,K=null,L=null;const U=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,B=0;const X=n.getParameter(n.VERSION);X.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(X)[1]),O=B>=1):X.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),O=B>=2);let Z=null,te={};const re=n.getParameter(n.SCISSOR_BOX),Ce=n.getParameter(n.VIEWPORT),oe=new ft().fromArray(re),xe=new ft().fromArray(Ce);function Y(N,ue,$,ye){const de=new Uint8Array(4),ee=n.createTexture();n.bindTexture(N,ee),n.texParameteri(N,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(N,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Re=0;Re<$;Re++)N===n.TEXTURE_3D||N===n.TEXTURE_2D_ARRAY?n.texImage3D(ue,0,n.RGBA,1,1,ye,0,n.RGBA,n.UNSIGNED_BYTE,de):n.texImage2D(ue+Re,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,de);return ee}const ae={};ae[n.TEXTURE_2D]=Y(n.TEXTURE_2D,n.TEXTURE_2D,1),ae[n.TEXTURE_CUBE_MAP]=Y(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ae[n.TEXTURE_2D_ARRAY]=Y(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ae[n.TEXTURE_3D]=Y(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),se(n.DEPTH_TEST),o.setFunc(to),Ut(!1),yt(Um),se(n.CULL_FACE),mt(Vi);function se(N){u[N]!==!0&&(n.enable(N),u[N]=!0)}function we(N){u[N]!==!1&&(n.disable(N),u[N]=!1)}function Ne(N,ue){return f[N]!==ue?(n.bindFramebuffer(N,ue),f[N]=ue,N===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=ue),N===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=ue),!0):!1}function Ie(N,ue){let $=m,ye=!1;if(N){$=p.get(ue),$===void 0&&($=[],p.set(ue,$));const de=N.textures;if($.length!==de.length||$[0]!==n.COLOR_ATTACHMENT0){for(let ee=0,Re=de.length;ee<Re;ee++)$[ee]=n.COLOR_ATTACHMENT0+ee;$.length=de.length,ye=!0}}else $[0]!==n.BACK&&($[0]=n.BACK,ye=!0);ye&&n.drawBuffers($)}function xt(N){return y!==N?(n.useProgram(N),y=N,!0):!1}const $e={[Hr]:n.FUNC_ADD,[oM]:n.FUNC_SUBTRACT,[aM]:n.FUNC_REVERSE_SUBTRACT};$e[lM]=n.MIN,$e[cM]=n.MAX;const ot={[uM]:n.ZERO,[fM]:n.ONE,[dM]:n.SRC_COLOR,[id]:n.SRC_ALPHA,[vM]:n.SRC_ALPHA_SATURATE,[gM]:n.DST_COLOR,[pM]:n.DST_ALPHA,[hM]:n.ONE_MINUS_SRC_COLOR,[rd]:n.ONE_MINUS_SRC_ALPHA,[_M]:n.ONE_MINUS_DST_COLOR,[mM]:n.ONE_MINUS_DST_ALPHA,[xM]:n.CONSTANT_COLOR,[yM]:n.ONE_MINUS_CONSTANT_COLOR,[SM]:n.CONSTANT_ALPHA,[MM]:n.ONE_MINUS_CONSTANT_ALPHA};function mt(N,ue,$,ye,de,ee,Re,Be,Rt,at){if(N===Vi){g===!0&&(we(n.BLEND),g=!1);return}if(g===!1&&(se(n.BLEND),g=!0),N!==sM){if(N!==h||at!==P){if((_!==Hr||b!==Hr)&&(n.blendEquation(n.FUNC_ADD),_=Hr,b=Hr),at)switch(N){case Xs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fm:n.blendFunc(n.ONE,n.ONE);break;case Om:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case km:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Ue("WebGLState: Invalid blending: ",N);break}else switch(N){case Xs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fm:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Om:Ue("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case km:Ue("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ue("WebGLState: Invalid blending: ",N);break}v=null,M=null,T=null,A=null,x.set(0,0,0),R=0,h=N,P=at}return}de=de||ue,ee=ee||$,Re=Re||ye,(ue!==_||de!==b)&&(n.blendEquationSeparate($e[ue],$e[de]),_=ue,b=de),($!==v||ye!==M||ee!==T||Re!==A)&&(n.blendFuncSeparate(ot[$],ot[ye],ot[ee],ot[Re]),v=$,M=ye,T=ee,A=Re),(Be.equals(x)===!1||Rt!==R)&&(n.blendColor(Be.r,Be.g,Be.b,Rt),x.copy(Be),R=Rt),h=N,P=!1}function je(N,ue){N.side===pi?we(n.CULL_FACE):se(n.CULL_FACE);let $=N.side===vn;ue&&($=!$),Ut($),N.blending===Xs&&N.transparent===!1?mt(Vi):mt(N.blending,N.blendEquation,N.blendSrc,N.blendDst,N.blendEquationAlpha,N.blendSrcAlpha,N.blendDstAlpha,N.blendColor,N.blendAlpha,N.premultipliedAlpha),o.setFunc(N.depthFunc),o.setTest(N.depthTest),o.setMask(N.depthWrite),s.setMask(N.colorWrite);const ye=N.stencilWrite;a.setTest(ye),ye&&(a.setMask(N.stencilWriteMask),a.setFunc(N.stencilFunc,N.stencilRef,N.stencilFuncMask),a.setOp(N.stencilFail,N.stencilZFail,N.stencilZPass)),I(N.polygonOffset,N.polygonOffsetFactor,N.polygonOffsetUnits),N.alphaToCoverage===!0?se(n.SAMPLE_ALPHA_TO_COVERAGE):we(n.SAMPLE_ALPHA_TO_COVERAGE)}function Ut(N){C!==N&&(N?n.frontFace(n.CW):n.frontFace(n.CCW),C=N)}function yt(N){N!==iM?(se(n.CULL_FACE),N!==F&&(N===Um?n.cullFace(n.BACK):N===rM?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):we(n.CULL_FACE),F=N}function xn(N){N!==W&&(O&&n.lineWidth(N),W=N)}function I(N,ue,$){N?(se(n.POLYGON_OFFSET_FILL),(K!==ue||L!==$)&&(K=ue,L=$,o.getReversed()&&(ue=-ue),n.polygonOffset(ue,$))):we(n.POLYGON_OFFSET_FILL)}function Ft(N){N?se(n.SCISSOR_TEST):we(n.SCISSOR_TEST)}function Ze(N){N===void 0&&(N=n.TEXTURE0+U-1),Z!==N&&(n.activeTexture(N),Z=N)}function dt(N,ue,$){$===void 0&&(Z===null?$=n.TEXTURE0+U-1:$=Z);let ye=te[$];ye===void 0&&(ye={type:void 0,texture:void 0},te[$]=ye),(ye.type!==N||ye.texture!==ue)&&(Z!==$&&(n.activeTexture($),Z=$),n.bindTexture(N,ue||ae[N]),ye.type=N,ye.texture=ue)}function pe(){const N=te[Z];N!==void 0&&N.type!==void 0&&(n.bindTexture(N.type,null),N.type=void 0,N.texture=void 0)}function wt(){try{n.compressedTexImage2D(...arguments)}catch(N){Ue("WebGLState:",N)}}function w(){try{n.compressedTexImage3D(...arguments)}catch(N){Ue("WebGLState:",N)}}function S(){try{n.texSubImage2D(...arguments)}catch(N){Ue("WebGLState:",N)}}function z(){try{n.texSubImage3D(...arguments)}catch(N){Ue("WebGLState:",N)}}function J(){try{n.compressedTexSubImage2D(...arguments)}catch(N){Ue("WebGLState:",N)}}function ne(){try{n.compressedTexSubImage3D(...arguments)}catch(N){Ue("WebGLState:",N)}}function le(){try{n.texStorage2D(...arguments)}catch(N){Ue("WebGLState:",N)}}function he(){try{n.texStorage3D(...arguments)}catch(N){Ue("WebGLState:",N)}}function q(){try{n.texImage2D(...arguments)}catch(N){Ue("WebGLState:",N)}}function Q(){try{n.texImage3D(...arguments)}catch(N){Ue("WebGLState:",N)}}function ve(N){return d[N]!==void 0?d[N]:n.getParameter(N)}function Me(N,ue){d[N]!==ue&&(n.pixelStorei(N,ue),d[N]=ue)}function fe(N){oe.equals(N)===!1&&(n.scissor(N.x,N.y,N.z,N.w),oe.copy(N))}function ce(N){xe.equals(N)===!1&&(n.viewport(N.x,N.y,N.z,N.w),xe.copy(N))}function Fe(N,ue){let $=c.get(ue);$===void 0&&($=new WeakMap,c.set(ue,$));let ye=$.get(N);ye===void 0&&(ye=n.getUniformBlockIndex(ue,N.name),$.set(N,ye))}function Ve(N,ue){const ye=c.get(ue).get(N);l.get(ue)!==ye&&(n.uniformBlockBinding(ue,ye,N.__bindingPointIndex),l.set(ue,ye))}function tt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},d={},Z=null,te={},f={},p=new WeakMap,m=[],y=null,g=!1,h=null,_=null,v=null,M=null,b=null,T=null,A=null,x=new ke(0,0,0),R=0,P=!1,C=null,F=null,W=null,K=null,L=null,oe.set(0,0,n.canvas.width,n.canvas.height),xe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:se,disable:we,bindFramebuffer:Ne,drawBuffers:Ie,useProgram:xt,setBlending:mt,setMaterial:je,setFlipSided:Ut,setCullFace:yt,setLineWidth:xn,setPolygonOffset:I,setScissorTest:Ft,activeTexture:Ze,bindTexture:dt,unbindTexture:pe,compressedTexImage2D:wt,compressedTexImage3D:w,texImage2D:q,texImage3D:Q,pixelStorei:Me,getParameter:ve,updateUBOMapping:Fe,uniformBlockBinding:Ve,texStorage2D:le,texStorage3D:he,texSubImage2D:S,texSubImage3D:z,compressedTexSubImage2D:J,compressedTexSubImage3D:ne,scissor:fe,viewport:ce,reset:tt}}function sR(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Je,u=new WeakMap,d=new Set;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(w,S){return m?new OffscreenCanvas(w,S):wa("canvas")}function g(w,S,z){let J=1;const ne=wt(w);if((ne.width>z||ne.height>z)&&(J=z/Math.max(ne.width,ne.height)),J<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const le=Math.floor(J*ne.width),he=Math.floor(J*ne.height);f===void 0&&(f=y(le,he));const q=S?y(le,he):f;return q.width=le,q.height=he,q.getContext("2d").drawImage(w,0,0,le,he),be("WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+le+"x"+he+")."),q}else return"data"in w&&be("WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),w;return w}function h(w){return w.generateMipmaps}function _(w){n.generateMipmap(w)}function v(w){return w.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?n.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function M(w,S,z,J,ne,le=!1){if(w!==null){if(n[w]!==void 0)return n[w];be("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let he;J&&(he=e.get("EXT_texture_norm16"),he||be("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let q=S;if(S===n.RED&&(z===n.FLOAT&&(q=n.R32F),z===n.HALF_FLOAT&&(q=n.R16F),z===n.UNSIGNED_BYTE&&(q=n.R8),z===n.UNSIGNED_SHORT&&he&&(q=he.R16_EXT),z===n.SHORT&&he&&(q=he.R16_SNORM_EXT)),S===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(q=n.R8UI),z===n.UNSIGNED_SHORT&&(q=n.R16UI),z===n.UNSIGNED_INT&&(q=n.R32UI),z===n.BYTE&&(q=n.R8I),z===n.SHORT&&(q=n.R16I),z===n.INT&&(q=n.R32I)),S===n.RG&&(z===n.FLOAT&&(q=n.RG32F),z===n.HALF_FLOAT&&(q=n.RG16F),z===n.UNSIGNED_BYTE&&(q=n.RG8),z===n.UNSIGNED_SHORT&&he&&(q=he.RG16_EXT),z===n.SHORT&&he&&(q=he.RG16_SNORM_EXT)),S===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(q=n.RG8UI),z===n.UNSIGNED_SHORT&&(q=n.RG16UI),z===n.UNSIGNED_INT&&(q=n.RG32UI),z===n.BYTE&&(q=n.RG8I),z===n.SHORT&&(q=n.RG16I),z===n.INT&&(q=n.RG32I)),S===n.RGB_INTEGER&&(z===n.UNSIGNED_BYTE&&(q=n.RGB8UI),z===n.UNSIGNED_SHORT&&(q=n.RGB16UI),z===n.UNSIGNED_INT&&(q=n.RGB32UI),z===n.BYTE&&(q=n.RGB8I),z===n.SHORT&&(q=n.RGB16I),z===n.INT&&(q=n.RGB32I)),S===n.RGBA_INTEGER&&(z===n.UNSIGNED_BYTE&&(q=n.RGBA8UI),z===n.UNSIGNED_SHORT&&(q=n.RGBA16UI),z===n.UNSIGNED_INT&&(q=n.RGBA32UI),z===n.BYTE&&(q=n.RGBA8I),z===n.SHORT&&(q=n.RGBA16I),z===n.INT&&(q=n.RGBA32I)),S===n.RGB&&(z===n.UNSIGNED_SHORT&&he&&(q=he.RGB16_EXT),z===n.SHORT&&he&&(q=he.RGB16_SNORM_EXT),z===n.UNSIGNED_INT_5_9_9_9_REV&&(q=n.RGB9_E5),z===n.UNSIGNED_INT_10F_11F_11F_REV&&(q=n.R11F_G11F_B10F)),S===n.RGBA){const Q=le?yc:Ye.getTransfer(ne);z===n.FLOAT&&(q=n.RGBA32F),z===n.HALF_FLOAT&&(q=n.RGBA16F),z===n.UNSIGNED_BYTE&&(q=Q===nt?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT&&he&&(q=he.RGBA16_EXT),z===n.SHORT&&he&&(q=he.RGBA16_SNORM_EXT),z===n.UNSIGNED_SHORT_4_4_4_4&&(q=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(q=n.RGB5_A1)}return(q===n.R16F||q===n.R32F||q===n.RG16F||q===n.RG32F||q===n.RGBA16F||q===n.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function b(w,S){let z;return w?S===null||S===Mi||S===Sa?z=n.DEPTH24_STENCIL8:S===kn?z=n.DEPTH32F_STENCIL8:S===ya&&(z=n.DEPTH24_STENCIL8,be("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===Mi||S===Sa?z=n.DEPTH_COMPONENT24:S===kn?z=n.DEPTH_COMPONENT32F:S===ya&&(z=n.DEPTH_COMPONENT16),z}function T(w,S){return h(w)===!0||w.isFramebufferTexture&&w.minFilter!==Bt&&w.minFilter!==zt?Math.log2(Math.max(S.width,S.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?S.mipmaps.length:1}function A(w){const S=w.target;S.removeEventListener("dispose",A),R(S),S.isVideoTexture&&u.delete(S),S.isHTMLTexture&&d.delete(S)}function x(w){const S=w.target;S.removeEventListener("dispose",x),C(S)}function R(w){const S=i.get(w);if(S.__webglInit===void 0)return;const z=w.source,J=p.get(z);if(J){const ne=J[S.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&P(w),Object.keys(J).length===0&&p.delete(z)}i.remove(w)}function P(w){const S=i.get(w);n.deleteTexture(S.__webglTexture);const z=w.source,J=p.get(z);delete J[S.__cacheKey],o.memory.textures--}function C(w){const S=i.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),i.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(S.__webglFramebuffer[J]))for(let ne=0;ne<S.__webglFramebuffer[J].length;ne++)n.deleteFramebuffer(S.__webglFramebuffer[J][ne]);else n.deleteFramebuffer(S.__webglFramebuffer[J]);S.__webglDepthbuffer&&n.deleteRenderbuffer(S.__webglDepthbuffer[J])}else{if(Array.isArray(S.__webglFramebuffer))for(let J=0;J<S.__webglFramebuffer.length;J++)n.deleteFramebuffer(S.__webglFramebuffer[J]);else n.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&n.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&n.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let J=0;J<S.__webglColorRenderbuffer.length;J++)S.__webglColorRenderbuffer[J]&&n.deleteRenderbuffer(S.__webglColorRenderbuffer[J]);S.__webglDepthRenderbuffer&&n.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const z=w.textures;for(let J=0,ne=z.length;J<ne;J++){const le=i.get(z[J]);le.__webglTexture&&(n.deleteTexture(le.__webglTexture),o.memory.textures--),i.remove(z[J])}i.remove(w)}let F=0;function W(){F=0}function K(){return F}function L(w){F=w}function U(){const w=F;return w>=r.maxTextures&&be("WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),F+=1,w}function O(w){const S=[];return S.push(w.wrapS),S.push(w.wrapT),S.push(w.wrapR||0),S.push(w.magFilter),S.push(w.minFilter),S.push(w.anisotropy),S.push(w.internalFormat),S.push(w.format),S.push(w.type),S.push(w.generateMipmaps),S.push(w.premultiplyAlpha),S.push(w.flipY),S.push(w.unpackAlignment),S.push(w.colorSpace),S.join()}function B(w,S){const z=i.get(w);if(w.isVideoTexture&&dt(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&z.__version!==w.version){const J=w.image;if(J===null)be("WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)be("WebGLRenderer: Texture marked for update but image is incomplete");else{we(z,w,S);return}}else w.isExternalTexture&&(z.__webglTexture=w.sourceTexture?w.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+S)}function X(w,S){const z=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){we(z,w,S);return}else w.isExternalTexture&&(z.__webglTexture=w.sourceTexture?w.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+S)}function Z(w,S){const z=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){we(z,w,S);return}t.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+S)}function te(w,S){const z=i.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&z.__version!==w.version){Ne(z,w,S);return}t.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+S)}const re={[io]:n.REPEAT,[mi]:n.CLAMP_TO_EDGE,[_c]:n.MIRRORED_REPEAT},Ce={[Bt]:n.NEAREST,[Cv]:n.NEAREST_MIPMAP_NEAREST,[Go]:n.NEAREST_MIPMAP_LINEAR,[zt]:n.LINEAR,[zl]:n.LINEAR_MIPMAP_NEAREST,[ki]:n.LINEAR_MIPMAP_LINEAR},oe={[PM]:n.NEVER,[UM]:n.ALWAYS,[LM]:n.LESS,[ep]:n.LEQUAL,[NM]:n.EQUAL,[tp]:n.GEQUAL,[IM]:n.GREATER,[DM]:n.NOTEQUAL};function xe(w,S){if(S.type===kn&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===zt||S.magFilter===zl||S.magFilter===Go||S.magFilter===ki||S.minFilter===zt||S.minFilter===zl||S.minFilter===Go||S.minFilter===ki)&&be("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(w,n.TEXTURE_WRAP_S,re[S.wrapS]),n.texParameteri(w,n.TEXTURE_WRAP_T,re[S.wrapT]),(w===n.TEXTURE_3D||w===n.TEXTURE_2D_ARRAY)&&n.texParameteri(w,n.TEXTURE_WRAP_R,re[S.wrapR]),n.texParameteri(w,n.TEXTURE_MAG_FILTER,Ce[S.magFilter]),n.texParameteri(w,n.TEXTURE_MIN_FILTER,Ce[S.minFilter]),S.compareFunction&&(n.texParameteri(w,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(w,n.TEXTURE_COMPARE_FUNC,oe[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Bt||S.minFilter!==Go&&S.minFilter!==ki||S.type===kn&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");n.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function Y(w,S){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,S.addEventListener("dispose",A));const J=S.source;let ne=p.get(J);ne===void 0&&(ne={},p.set(J,ne));const le=O(S);if(le!==w.__cacheKey){ne[le]===void 0&&(ne[le]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,z=!0),ne[le].usedTimes++;const he=ne[w.__cacheKey];he!==void 0&&(ne[w.__cacheKey].usedTimes--,he.usedTimes===0&&P(S)),w.__cacheKey=le,w.__webglTexture=ne[le].texture}return z}function ae(w,S,z){return Math.floor(Math.floor(w/z)/S)}function se(w,S,z,J){const le=w.updateRanges;if(le.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,S.width,S.height,z,J,S.data);else{le.sort((Me,fe)=>Me.start-fe.start);let he=0;for(let Me=1;Me<le.length;Me++){const fe=le[he],ce=le[Me],Fe=fe.start+fe.count,Ve=ae(ce.start,S.width,4),tt=ae(fe.start,S.width,4);ce.start<=Fe+1&&Ve===tt&&ae(ce.start+ce.count-1,S.width,4)===Ve?fe.count=Math.max(fe.count,ce.start+ce.count-fe.start):(++he,le[he]=ce)}le.length=he+1;const q=t.getParameter(n.UNPACK_ROW_LENGTH),Q=t.getParameter(n.UNPACK_SKIP_PIXELS),ve=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,S.width);for(let Me=0,fe=le.length;Me<fe;Me++){const ce=le[Me],Fe=Math.floor(ce.start/4),Ve=Math.ceil(ce.count/4),tt=Fe%S.width,N=Math.floor(Fe/S.width),ue=Ve,$=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,tt),t.pixelStorei(n.UNPACK_SKIP_ROWS,N),t.texSubImage2D(n.TEXTURE_2D,0,tt,N,ue,$,z,J,S.data)}w.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,q),t.pixelStorei(n.UNPACK_SKIP_PIXELS,Q),t.pixelStorei(n.UNPACK_SKIP_ROWS,ve)}}function we(w,S,z){let J=n.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(J=n.TEXTURE_2D_ARRAY),S.isData3DTexture&&(J=n.TEXTURE_3D);const ne=Y(w,S),le=S.source;t.bindTexture(J,w.__webglTexture,n.TEXTURE0+z);const he=i.get(le);if(le.version!==he.__version||ne===!0){if(t.activeTexture(n.TEXTURE0+z),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){const $=Ye.getPrimaries(Ye.workingColorSpace),ye=S.colorSpace===hr?null:Ye.getPrimaries(S.colorSpace),de=S.colorSpace===hr||$===ye?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,de)}t.pixelStorei(n.UNPACK_ALIGNMENT,S.unpackAlignment);let Q=g(S.image,!1,r.maxTextureSize);Q=pe(S,Q);const ve=s.convert(S.format,S.colorSpace),Me=s.convert(S.type);let fe=M(S.internalFormat,ve,Me,S.normalized,S.colorSpace,S.isVideoTexture);xe(J,S);let ce;const Fe=S.mipmaps,Ve=S.isVideoTexture!==!0,tt=he.__version===void 0||ne===!0,N=le.dataReady,ue=T(S,Q);if(S.isDepthTexture)fe=b(S.format===Yr,S.type),tt&&(Ve?t.texStorage2D(n.TEXTURE_2D,1,fe,Q.width,Q.height):t.texImage2D(n.TEXTURE_2D,0,fe,Q.width,Q.height,0,ve,Me,null));else if(S.isDataTexture)if(Fe.length>0){Ve&&tt&&t.texStorage2D(n.TEXTURE_2D,ue,fe,Fe[0].width,Fe[0].height);for(let $=0,ye=Fe.length;$<ye;$++)ce=Fe[$],Ve?N&&t.texSubImage2D(n.TEXTURE_2D,$,0,0,ce.width,ce.height,ve,Me,ce.data):t.texImage2D(n.TEXTURE_2D,$,fe,ce.width,ce.height,0,ve,Me,ce.data);S.generateMipmaps=!1}else Ve?(tt&&t.texStorage2D(n.TEXTURE_2D,ue,fe,Q.width,Q.height),N&&se(S,Q,ve,Me)):t.texImage2D(n.TEXTURE_2D,0,fe,Q.width,Q.height,0,ve,Me,Q.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ve&&tt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ue,fe,Fe[0].width,Fe[0].height,Q.depth);for(let $=0,ye=Fe.length;$<ye;$++)if(ce=Fe[$],S.format!==Bn)if(ve!==null)if(Ve){if(N)if(S.layerUpdates.size>0){const de=Cg(ce.width,ce.height,S.format,S.type);for(const ee of S.layerUpdates){const Re=ce.data.subarray(ee*de/ce.data.BYTES_PER_ELEMENT,(ee+1)*de/ce.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,$,0,0,ee,ce.width,ce.height,1,ve,Re)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,$,0,0,0,ce.width,ce.height,Q.depth,ve,ce.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,$,fe,ce.width,ce.height,Q.depth,0,ce.data,0,0);else be("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ve?N&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,$,0,0,0,ce.width,ce.height,Q.depth,ve,Me,ce.data):t.texImage3D(n.TEXTURE_2D_ARRAY,$,fe,ce.width,ce.height,Q.depth,0,ve,Me,ce.data)}else{Ve&&tt&&t.texStorage2D(n.TEXTURE_2D,ue,fe,Fe[0].width,Fe[0].height);for(let $=0,ye=Fe.length;$<ye;$++)ce=Fe[$],S.format!==Bn?ve!==null?Ve?N&&t.compressedTexSubImage2D(n.TEXTURE_2D,$,0,0,ce.width,ce.height,ve,ce.data):t.compressedTexImage2D(n.TEXTURE_2D,$,fe,ce.width,ce.height,0,ce.data):be("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?N&&t.texSubImage2D(n.TEXTURE_2D,$,0,0,ce.width,ce.height,ve,Me,ce.data):t.texImage2D(n.TEXTURE_2D,$,fe,ce.width,ce.height,0,ve,Me,ce.data)}else if(S.isDataArrayTexture)if(Ve){if(tt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ue,fe,Q.width,Q.height,Q.depth),N)if(S.layerUpdates.size>0){const $=Cg(Q.width,Q.height,S.format,S.type);for(const ye of S.layerUpdates){const de=Q.data.subarray(ye*$/Q.data.BYTES_PER_ELEMENT,(ye+1)*$/Q.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ye,Q.width,Q.height,1,ve,Me,de)}S.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ve,Me,Q.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,fe,Q.width,Q.height,Q.depth,0,ve,Me,Q.data);else if(S.isData3DTexture)Ve?(tt&&t.texStorage3D(n.TEXTURE_3D,ue,fe,Q.width,Q.height,Q.depth),N&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ve,Me,Q.data)):t.texImage3D(n.TEXTURE_3D,0,fe,Q.width,Q.height,Q.depth,0,ve,Me,Q.data);else if(S.isFramebufferTexture){if(tt)if(Ve)t.texStorage2D(n.TEXTURE_2D,ue,fe,Q.width,Q.height);else{let $=Q.width,ye=Q.height;for(let de=0;de<ue;de++)t.texImage2D(n.TEXTURE_2D,de,fe,$,ye,0,ve,Me,null),$>>=1,ye>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in n){const $=n.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),Q.parentNode!==$){$.appendChild(Q),d.add(S),$.onpaint=Be=>{const Rt=Be.changedElements;for(const at of d)Rt.includes(at.image)&&(at.needsUpdate=!0)},$.requestPaint();return}const ye=0,de=n.RGBA,ee=n.RGBA,Re=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,ye,de,ee,Re,Q),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(Ve&&tt){const $=wt(Fe[0]);t.texStorage2D(n.TEXTURE_2D,ue,fe,$.width,$.height)}for(let $=0,ye=Fe.length;$<ye;$++)ce=Fe[$],Ve?N&&t.texSubImage2D(n.TEXTURE_2D,$,0,0,ve,Me,ce):t.texImage2D(n.TEXTURE_2D,$,fe,ve,Me,ce);S.generateMipmaps=!1}else if(Ve){if(tt){const $=wt(Q);t.texStorage2D(n.TEXTURE_2D,ue,fe,$.width,$.height)}N&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ve,Me,Q)}else t.texImage2D(n.TEXTURE_2D,0,fe,ve,Me,Q);h(S)&&_(J),he.__version=le.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function Ne(w,S,z){if(S.image.length!==6)return;const J=Y(w,S),ne=S.source;t.bindTexture(n.TEXTURE_CUBE_MAP,w.__webglTexture,n.TEXTURE0+z);const le=i.get(ne);if(ne.version!==le.__version||J===!0){t.activeTexture(n.TEXTURE0+z);const he=Ye.getPrimaries(Ye.workingColorSpace),q=S.colorSpace===hr?null:Ye.getPrimaries(S.colorSpace),Q=S.colorSpace===hr||he===q?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);const ve=S.isCompressedTexture||S.image[0].isCompressedTexture,Me=S.image[0]&&S.image[0].isDataTexture,fe=[];for(let ee=0;ee<6;ee++)!ve&&!Me?fe[ee]=g(S.image[ee],!0,r.maxCubemapSize):fe[ee]=Me?S.image[ee].image:S.image[ee],fe[ee]=pe(S,fe[ee]);const ce=fe[0],Fe=s.convert(S.format,S.colorSpace),Ve=s.convert(S.type),tt=M(S.internalFormat,Fe,Ve,S.normalized,S.colorSpace),N=S.isVideoTexture!==!0,ue=le.__version===void 0||J===!0,$=ne.dataReady;let ye=T(S,ce);xe(n.TEXTURE_CUBE_MAP,S);let de;if(ve){N&&ue&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,tt,ce.width,ce.height);for(let ee=0;ee<6;ee++){de=fe[ee].mipmaps;for(let Re=0;Re<de.length;Re++){const Be=de[Re];S.format!==Bn?Fe!==null?N?$&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re,0,0,Be.width,Be.height,Fe,Be.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re,tt,Be.width,Be.height,0,Be.data):be("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):N?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re,0,0,Be.width,Be.height,Fe,Ve,Be.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re,tt,Be.width,Be.height,0,Fe,Ve,Be.data)}}}else{if(de=S.mipmaps,N&&ue){de.length>0&&ye++;const ee=wt(fe[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,tt,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Me){N?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,fe[ee].width,fe[ee].height,Fe,Ve,fe[ee].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,tt,fe[ee].width,fe[ee].height,0,Fe,Ve,fe[ee].data);for(let Re=0;Re<de.length;Re++){const Rt=de[Re].image[ee].image;N?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re+1,0,0,Rt.width,Rt.height,Fe,Ve,Rt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re+1,tt,Rt.width,Rt.height,0,Fe,Ve,Rt.data)}}else{N?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Fe,Ve,fe[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,tt,Fe,Ve,fe[ee]);for(let Re=0;Re<de.length;Re++){const Be=de[Re];N?$&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re+1,0,0,Fe,Ve,Be.image[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Re+1,tt,Fe,Ve,Be.image[ee])}}}h(S)&&_(n.TEXTURE_CUBE_MAP),le.__version=ne.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function Ie(w,S,z,J,ne,le){const he=s.convert(z.format,z.colorSpace),q=s.convert(z.type),Q=M(z.internalFormat,he,q,z.normalized,z.colorSpace),ve=i.get(S),Me=i.get(z);if(Me.__renderTarget=S,!ve.__hasExternalTextures){const fe=Math.max(1,S.width>>le),ce=Math.max(1,S.height>>le);ne===n.TEXTURE_3D||ne===n.TEXTURE_2D_ARRAY?t.texImage3D(ne,le,Q,fe,ce,S.depth,0,he,q,null):t.texImage2D(ne,le,Q,fe,ce,0,he,q,null)}t.bindFramebuffer(n.FRAMEBUFFER,w),Ze(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,J,ne,Me.__webglTexture,0,Ft(S)):(ne===n.TEXTURE_2D||ne>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,J,ne,Me.__webglTexture,le),t.bindFramebuffer(n.FRAMEBUFFER,null)}function xt(w,S,z){if(n.bindRenderbuffer(n.RENDERBUFFER,w),S.depthBuffer){const J=S.depthTexture,ne=J&&J.isDepthTexture?J.type:null,le=b(S.stencilBuffer,ne),he=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Ze(S)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ft(S),le,S.width,S.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ft(S),le,S.width,S.height):n.renderbufferStorage(n.RENDERBUFFER,le,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,w)}else{const J=S.textures;for(let ne=0;ne<J.length;ne++){const le=J[ne],he=s.convert(le.format,le.colorSpace),q=s.convert(le.type),Q=M(le.internalFormat,he,q,le.normalized,le.colorSpace);Ze(S)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ft(S),Q,S.width,S.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ft(S),Q,S.width,S.height):n.renderbufferStorage(n.RENDERBUFFER,Q,S.width,S.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function $e(w,S,z){const J=S.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,w),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ne=i.get(S.depthTexture);if(ne.__renderTarget=S,(!ne.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),J){if(ne.__webglInit===void 0&&(ne.__webglInit=!0,S.depthTexture.addEventListener("dispose",A)),ne.__webglTexture===void 0){ne.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,ne.__webglTexture),xe(n.TEXTURE_CUBE_MAP,S.depthTexture);const ve=s.convert(S.depthTexture.format),Me=s.convert(S.depthTexture.type);let fe;S.depthTexture.format===qi?fe=n.DEPTH_COMPONENT24:S.depthTexture.format===Yr&&(fe=n.DEPTH24_STENCIL8);for(let ce=0;ce<6;ce++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,fe,S.width,S.height,0,ve,Me,null)}}else B(S.depthTexture,0);const le=ne.__webglTexture,he=Ft(S),q=J?n.TEXTURE_CUBE_MAP_POSITIVE_X+z:n.TEXTURE_2D,Q=S.depthTexture.format===Yr?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(S.depthTexture.format===qi)Ze(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,q,le,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,Q,q,le,0);else if(S.depthTexture.format===Yr)Ze(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,q,le,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,Q,q,le,0);else throw new Error("Unknown depthTexture format")}function ot(w){const S=i.get(w),z=w.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==w.depthTexture){const J=w.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),J){const ne=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,J.removeEventListener("dispose",ne)};J.addEventListener("dispose",ne),S.__depthDisposeCallback=ne}S.__boundDepthTexture=J}if(w.depthTexture&&!S.__autoAllocateDepthBuffer)if(z)for(let J=0;J<6;J++)$e(S.__webglFramebuffer[J],w,J);else{const J=w.texture.mipmaps;J&&J.length>0?$e(S.__webglFramebuffer[0],w,0):$e(S.__webglFramebuffer,w,0)}else if(z){S.__webglDepthbuffer=[];for(let J=0;J<6;J++)if(t.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer[J]),S.__webglDepthbuffer[J]===void 0)S.__webglDepthbuffer[J]=n.createRenderbuffer(),xt(S.__webglDepthbuffer[J],w,!1);else{const ne=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=S.__webglDepthbuffer[J];n.bindRenderbuffer(n.RENDERBUFFER,le),n.framebufferRenderbuffer(n.FRAMEBUFFER,ne,n.RENDERBUFFER,le)}}else{const J=w.texture.mipmaps;if(J&&J.length>0?t.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=n.createRenderbuffer(),xt(S.__webglDepthbuffer,w,!1);else{const ne=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=S.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,le),n.framebufferRenderbuffer(n.FRAMEBUFFER,ne,n.RENDERBUFFER,le)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function mt(w,S,z){const J=i.get(w);S!==void 0&&Ie(J.__webglFramebuffer,w,w.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&ot(w)}function je(w){const S=w.texture,z=i.get(w),J=i.get(S);w.addEventListener("dispose",x);const ne=w.textures,le=w.isWebGLCubeRenderTarget===!0,he=ne.length>1;if(he||(J.__webglTexture===void 0&&(J.__webglTexture=n.createTexture()),J.__version=S.version,o.memory.textures++),le){z.__webglFramebuffer=[];for(let q=0;q<6;q++)if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[q]=[];for(let Q=0;Q<S.mipmaps.length;Q++)z.__webglFramebuffer[q][Q]=n.createFramebuffer()}else z.__webglFramebuffer[q]=n.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let q=0;q<S.mipmaps.length;q++)z.__webglFramebuffer[q]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(he)for(let q=0,Q=ne.length;q<Q;q++){const ve=i.get(ne[q]);ve.__webglTexture===void 0&&(ve.__webglTexture=n.createTexture(),o.memory.textures++)}if(w.samples>0&&Ze(w)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let q=0;q<ne.length;q++){const Q=ne[q];z.__webglColorRenderbuffer[q]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[q]);const ve=s.convert(Q.format,Q.colorSpace),Me=s.convert(Q.type),fe=M(Q.internalFormat,ve,Me,Q.normalized,Q.colorSpace,w.isXRRenderTarget===!0),ce=Ft(w);n.renderbufferStorageMultisample(n.RENDERBUFFER,ce,fe,w.width,w.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+q,n.RENDERBUFFER,z.__webglColorRenderbuffer[q])}n.bindRenderbuffer(n.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),xt(z.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(le){t.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),xe(n.TEXTURE_CUBE_MAP,S);for(let q=0;q<6;q++)if(S.mipmaps&&S.mipmaps.length>0)for(let Q=0;Q<S.mipmaps.length;Q++)Ie(z.__webglFramebuffer[q][Q],w,S,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+q,Q);else Ie(z.__webglFramebuffer[q],w,S,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+q,0);h(S)&&_(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(he){for(let q=0,Q=ne.length;q<Q;q++){const ve=ne[q],Me=i.get(ve);let fe=n.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(fe=w.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(fe,Me.__webglTexture),xe(fe,ve),Ie(z.__webglFramebuffer,w,ve,n.COLOR_ATTACHMENT0+q,fe,0),h(ve)&&_(fe)}t.unbindTexture()}else{let q=n.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(q=w.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(q,J.__webglTexture),xe(q,S),S.mipmaps&&S.mipmaps.length>0)for(let Q=0;Q<S.mipmaps.length;Q++)Ie(z.__webglFramebuffer[Q],w,S,n.COLOR_ATTACHMENT0,q,Q);else Ie(z.__webglFramebuffer,w,S,n.COLOR_ATTACHMENT0,q,0);h(S)&&_(q),t.unbindTexture()}w.depthBuffer&&ot(w)}function Ut(w){const S=w.textures;for(let z=0,J=S.length;z<J;z++){const ne=S[z];if(h(ne)){const le=v(w),he=i.get(ne).__webglTexture;t.bindTexture(le,he),_(le),t.unbindTexture()}}}const yt=[],xn=[];function I(w){if(w.samples>0){if(Ze(w)===!1){const S=w.textures,z=w.width,J=w.height;let ne=n.COLOR_BUFFER_BIT;const le=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,he=i.get(w),q=S.length>1;if(q)for(let ve=0;ve<S.length;ve++)t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer);const Q=w.texture.mipmaps;Q&&Q.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let ve=0;ve<S.length;ve++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(ne|=n.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(ne|=n.STENCIL_BUFFER_BIT)),q){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,he.__webglColorRenderbuffer[ve]);const Me=i.get(S[ve]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Me,0)}n.blitFramebuffer(0,0,z,J,0,0,z,J,ne,n.NEAREST),l===!0&&(yt.length=0,xn.length=0,yt.push(n.COLOR_ATTACHMENT0+ve),w.depthBuffer&&w.resolveDepthBuffer===!1&&(yt.push(le),xn.push(le),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,xn)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,yt))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),q)for(let ve=0;ve<S.length;ve++){t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.RENDERBUFFER,he.__webglColorRenderbuffer[ve]);const Me=i.get(S[ve]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.TEXTURE_2D,Me,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const S=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[S])}}}function Ft(w){return Math.min(r.maxSamples,w.samples)}function Ze(w){const S=i.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function dt(w){const S=o.render.frame;u.get(w)!==S&&(u.set(w,S),w.update())}function pe(w,S){const z=w.colorSpace,J=w.format,ne=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==Rn&&z!==hr&&(Ye.getTransfer(z)===nt?(J!==Bn||ne!==Tn)&&be("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ue("WebGLTextures: Unsupported texture color space:",z)),S}function wt(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=U,this.resetTextureUnits=W,this.getTextureUnits=K,this.setTextureUnits=L,this.setTexture2D=B,this.setTexture2DArray=X,this.setTexture3D=Z,this.setTextureCube=te,this.rebindTextures=mt,this.setupRenderTarget=je,this.updateRenderTargetMipmap=Ut,this.updateMultisampleRenderTarget=I,this.setupDepthRenderbuffer=ot,this.setupFrameBufferTexture=Ie,this.useMultisampledRTT=Ze,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function oR(n,e){function t(i,r=hr){let s;const o=Ye.getTransfer(r);if(i===Tn)return n.UNSIGNED_BYTE;if(i===Kh)return n.UNSIGNED_SHORT_4_4_4_4;if(i===qh)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Nv)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Iv)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Pv)return n.BYTE;if(i===Lv)return n.SHORT;if(i===ya)return n.UNSIGNED_SHORT;if(i===Yh)return n.INT;if(i===Mi)return n.UNSIGNED_INT;if(i===kn)return n.FLOAT;if(i===Ki)return n.HALF_FLOAT;if(i===Dv)return n.ALPHA;if(i===Uv)return n.RGB;if(i===Bn)return n.RGBA;if(i===qi)return n.DEPTH_COMPONENT;if(i===Yr)return n.DEPTH_STENCIL;if(i===$h)return n.RED;if(i===Zh)return n.RED_INTEGER;if(i===is)return n.RG;if(i===Jh)return n.RG_INTEGER;if(i===Qh)return n.RGBA_INTEGER;if(i===Vl||i===Hl||i===Gl||i===Wl)if(o===nt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Vl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Hl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Gl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Wl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Vl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Hl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Gl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Wl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===dd||i===hd||i===pd||i===md)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===dd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===hd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===pd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===md)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===gd||i===_d||i===vd||i===xd||i===yd||i===vc||i===Sd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===gd||i===_d)return o===nt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===vd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===xd)return s.COMPRESSED_R11_EAC;if(i===yd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===vc)return s.COMPRESSED_RG11_EAC;if(i===Sd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Md||i===Ed||i===Td||i===wd||i===Ad||i===bd||i===Rd||i===Cd||i===Pd||i===Ld||i===Nd||i===Id||i===Dd||i===Ud)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Md)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ed)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Td)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===wd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Ad)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===bd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Rd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Cd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Pd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ld)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Nd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Id)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Dd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Ud)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Fd||i===Od||i===kd)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Fd)return o===nt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Od)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===kd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Bd||i===zd||i===xc||i===Vd)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Bd)return s.COMPRESSED_RED_RGTC1_EXT;if(i===zd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===xc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Vd)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Sa?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const aR=`
void main() {
