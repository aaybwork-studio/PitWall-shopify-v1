function xx(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var o0={exports:{}},Tc={},a0={exports:{}},Ze={};/**
 * @license React
 ...
 */var ba=Symbol.for("react.element"),yx=Symbol.for("react.portal"),Sx=Symbol.for("react.fragment"),Mx=Symbol.for("react.strict_mode"),Ex=Symbol.for("react.profiler"),Tx=Symbol.for("react.provider"),wx=Symbol.for("react.context"),bx=Symbol.for("react.forward_ref"),Ax=Symbol.for("react.suspense"),Rx=Symbol.for("react.memo"),Cx=Symbol.for("react.lazy"),bp=Symbol.iterator;function Px(n){return n===null||typeof n!="object"?null:(n=bp&&n[bp]||n["@@iterator"],typeof n=="function"?n:null)}var l0={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},c0=Object.assign,u0={};function uo(n,e,t){this.props=n,this.context=e,this.refs=u0,this.updater=t||l0}uo.prototype.isReactComponent={};uo.prototype.setState=function(n,e){if(typeof n!="object"&&typeof n!="function"&&n!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,n,e,"setState")};uo.prototype.forceUpdate=function(n){this.updater.enqueueForceUpdate(this,n,"forceUpdate")};function f0(){}f0.prototype=uo.prototype;function Qd(n,e,t){this.props=n,this.context=e,this.refs=u0,this.updater=t||l0}var eh=Qd.prototype=new f0;eh.constructor=Qd;c0(eh,uo.prototype);eh.isPureReactComponent=!0;var Ap=Array.isArray,d0=Object.prototype.hasOwnProperty,th={current:null},h0={key:!0,ref:!0,__self:!0,__source:!0};function p0(n,e,t){var i,r={},s=null,o=null;if(e!=null)for(i in e.ref!==void 0&&(o=e.ref),e.key!==void 0&&(s=""+e.key),e)d0.call(e,i)&&!h0.hasOwnProperty(i)&&(r[i]=e[i]);var a=arguments.length-2;if(a===1)r.children=t;else if(1<a){for(var l=Array(a),c=0;c<a;c++)l[c]=arguments[c+2];r.children=l}if(n&&n.defaultProps)for(i in a=n.defaultProps,a)r[i]===void 0&&(r[i]=a[i]);return{$$typeof:ba,type:n,key:s,ref:o,props:r,_owner:th.current}}function Lx(n,e){return{$$typeof:ba,type:n.type,key:e,ref:n.ref,props:n.props,_owner:n._owner}}function nh(n){return typeof n=="object"&&n!==null&&n.$$typeof===ba}function Ix(n){var e={"=":"=0",":":"=2"};return"$"+n.replace(/[=:]/g,function(t){return e[t]})}var Rp=/\/+/g;function $c(n,e){return typeof n=="object"&&n!==null&&n.key!=null?Ix(""+n.key):e.toString(36)}function bl(n,e,t,i,r){var s=typeof n;(s==="undefined"||s==="boolean")&&(n=null);var o=!1;if(n===null)o=!0;else switch(s){case"string":case"number":o=!0;break;case"object":switch(n.$$typeof){case ba:case yx:o=!0}}if(o)return o=n,r=r(o),n=i===""?"."+$c(o,0):i,Ap(r)?(t="",n!=null&&(t=n.replace(Rp,"$&/")+"/"),bl(r,e,t,"",function(c){return c})):r!=null&&(nh(r)&&(r=Lx(r,t+(!r.key||o&&o.key===r.key?"":(""+r.key).replace(Rp,"$&/")+"/")+n)),e.push(r)),1;if(o=0,i=i===""?".":i+":",Ap(n))for(var a=0;a<n.length;a++){s=n[a];var l=i+$c(s,a);o+=bl(s,e,t,l,r)}else if(l=Px(n),typeof l=="function")for(n=l.call(n),a=0;!(s=n.next()).done;)s=s.value,l=i+$c(s,a++),o+=bl(s,e,t,l,r);else if(s==="object")throw e=String(n),Error("Objects are not valid as a React child (found: "+(e==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":e)+"). If you meant to render a collection of children, use an array instead.");return o}function Da(n,e,t){if(n==null)return n;var i=[],r=0;return bl(n,i,"","",function(s){return e.call(t,s,r++)}),i}function Nx(n){if(n._status===-1){var e=n._result;e=e(),e.then(function(t){(n._status===0||n._status===-1)&&(n._status=1,n._result=t)},function(t){(n._status===0||n._status===-1)&&(n._status=2,n._result=t)}),n._status===-1&&(n._status=0,n._result=e)}if(n._status===1)return n._result.default;throw n._result}var fn={current:null},Al={transition:null},Dx={ReactCurrentDispatcher:fn,ReactCurrentBatchConfig:Al,ReactCurrentOwner:th};function m0(){throw Error("act(...) is not supported in production builds of React.")}Ze.Children={map:Da,forEach:function(n,e,t){Da(n,function(){e.apply(this,arguments)},t)},count:function(n){var e=0;return Da(n,function(){e++}),e},toArray:function(n){return Da(n,function(e){return e})||[]},only:function(n){if(!nh(n))throw Error("React.Children.only expected to receive a single React element child.");return n}};Ze.Component=uo;Ze.Fragment=Sx;Ze.Profiler=Ex;Ze.PureComponent=Qd;Ze.StrictMode=Mx;Ze.Suspense=Ax;Ze.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Dx;Ze.act=m0;Ze.cloneElement=function(n,e,t){if(n==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+n+".");var i=c0({},n.props),r=n.key,s=n.ref,o=n._owner;if(e!=null){if(e.ref!==void 0&&(s=e.ref,o=th.current),e.key!==void 0&&(r=""+e.key),n.type&&n.type.defaultProps)var a=n.type.defaultProps;for(l in e)d0.call(e,l)&&!h0.hasOwnProperty(l)&&(i[l]=e[l]===void 0&&a!==void 0?a[l]:e[l])}var l=arguments.length-2;if(l===1)i.children=t;else if(1<l){a=Array(l);for(var c=0;c<l;c++)a[c]=arguments[c+2];i.children=a}return{$$typeof:ba,type:n.type,key:r,ref:s,props:i,_owner:o}};Ze.createContext=function(n){return n={$$typeof:wx,_currentValue:n,_currentValue2:n,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},n.Provider={$$typeof:Tx,_context:n},n.Consumer=n};Ze.createElement=p0;Ze.createFactory=function(n){var e=p0.bind(null,n);return e.type=n,e};Ze.createRef=function(){return{current:null}};Ze.forwardRef=function(n){return{$$typeof:bx,render:n}};Ze.isValidElement=nh;Ze.lazy=function(n){return{$$typeof:Cx,_payload:{_status:-1,_result:n},_init:Nx}};Ze.memo=function(n,e){return{$$typeof:Rx,type:n,compare:e===void 0?null:e}};Ze.startTransition=function(n){var e=Al.transition;Al.transition={};try{n()}finally{Al.transition=e}};Ze.unstable_act=m0;Ze.useCallback=function(n,e){return fn.current.useCallback(n,e)};Ze.useContext=function(n){return fn.current.useContext(n)};Ze.useDebugValue=function(){};Ze.useDeferredValue=function(n){return fn.current.useDeferredValue(n)};Ze.useEffect=function(n,e){return fn.current.useEffect(n,e)};Ze.useId=function(){return fn.current.useId()};Ze.useImperativeHandle=function(n,e,t){return fn.current.useImperativeHandle(n,e,t)};Ze.useInsertionEffect=function(n,e){return fn.current.useInsertionEffect(n,e)};Ze.useLayoutEffect=function(n,e){return fn.current.useLayoutEffect(n,e)};Ze.useMemo=function(n,e){return fn.current.useMemo(n,e)};Ze.useReducer=function(n,e,t){return fn.current.useReducer(n,e,t)};Ze.useRef=function(n){return fn.current.useRef(n)};Ze.useState=function(n){return fn.current.useState(n)};Ze.useSyncExternalStore=function(n,e,t){return fn.current.useSyncExternalStore(n,e,t)};Ze.useTransition=function(){return fn.current.useTransition()};Ze.version="18.3.1";a0.exports=Ze;var Ue=a0.exports;const Cp=xx(Ue);/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const KS=Ue.forwardRef(({color:n="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:i,className:r="",children:s,iconNode:o,...a},l)=>Ue.createElement("svg",{ref:l,...YS,width:e,height:e,stroke:n,strokeWidth:i?Number(t)*24/Number(e):t,className:vv("lucide",r),...a},[...o.map(([c,f])=>Ue.createElement(c,f)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.378.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function hb(n,e,t){const i=new Float32Array(Gr),r=new O(0,1,0);return new Ei({name:"SphericalGaussianBlur",defines:{n:Gr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:jc(),fragmentShader:`
...
`)}const vA={[Sv]:"Linear",[Mv]:"Reinhard",[Ev]:"Cineon",[Tv]:"ACESFilmic",[bv]:"AgX",[Av]:"Neutral",[wv]:"Custom"};function xA(n,e){const t=vA[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Tl=new O;function yA(){qe.getLuminanceCoefficients(Tl);const n=Tl.x.toFixed(4),e=Tl.y.toFixed(4),t=Tl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const CA={[kl]:"SHADOWMAP_TYPE_PCF",[Ho]:"SHADOWMAP_TYPE_VSM"};function PA(n){return CA[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const LA={[ns]:"ENVMAP_TYPE_CUBE",[no]:"ENVMAP_TYPE_CUBE",[zc]:"ENVMAP_TYPE_CUBE_UV"};function IA(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":LA[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const NA={[no]:"ENVMAP_MODE_REFRACTION"};function DA(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":NA[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const UA={[yv]:"ENVMAP_BLENDING_MULTIPLY",[EM]:"ENVMAP_BLENDING_MIX",[TM]:"ENVMAP_BLENDING_ADD"};function FA(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":UA[n.combine]||"ENVMAP_BLENDING_NONE"}function OA(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function kA(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=PA(t),c=IA(t),f=DA(t),d=FA(t),u=OA(t),p=SA(t),m=MA(s),v=r.createProgram();let g,h,_=t.glslVersion?"#version "+t.glslVersion+`
