 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(B,W){var $=B.length;B.push(W);e:for(;0<$;){var te=$-1>>>1,oe=B[te];if(0<r(oe,W))B[te]=W,B[$]=oe,$=te;else break e}}function t(B){return B.length===0?null:B[0]}function i(B){if(B.length===0)return null;var W=B[0],$=B.pop();if($!==W){B[0]=$;e:for(var te=0,oe=B.length,re=oe>>>1;te<re;){var ye=2*(te+1)-1,Ae=B[ye],Y=ye+1,ue=B[Y];if(0>r(Ae,$))Y<oe&&0>r(ue,Ae)?(B[te]=ue,B[Y]=$,te=Y):(B[te]=Ae,B[ye]=$,te=ye);else if(Y<oe&&0>r(ue,$))B[te]=ue,B[Y]=$,te=Y;else break e}}return W}function r(B,W){var $=B.sortIndex-W.sortIndex;return $!==0?$:B.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],c=[],u=1,d=null,f=3,p=!1,m=!1,y=!1,g=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(B){for(var W=t(c);W!==null;){if(W.callback===null)i(c);else if(W.startTime<=B)i(c),W.sortIndex=W.expirationTime,e(l,W);else break;W=t(c)}}function M(B){if(y=!1,v(B),!m)if(t(l)!==null)m=!0,F(b);else{var W=t(c);W!==null&&O(M,W.startTime-B)}}function b(B,W){m=!1,y&&(y=!1,h(x),x=-1),p=!0;var $=f;try{for(v(W),d=t(l);d!==null&&(!(d.expirationTime>W)||B&&!C());){var te=d.callback;if(typeof te=="function"){d.callback=null,f=d.priorityLevel;var oe=te(d.expirationTime<=W);W=n.unstable_now(),typeof oe=="function"?d.callback=oe:d===t(l)&&i(l),v(W)}else i(l);d=t(l)}if(d!==null)var re=!0;else{var ye=t(c);ye!==null&&O(M,ye.startTime-W),re=!1}return re}finally{d=null,f=$,p=!1}}var T=!1,A=null,x=-1,R=5,P=-1;function C(){return!(n.unstable_now()-P<R)}function U(){if(A!==null){var B=n.unstable_now();P=B;var W=!0;try{W=A(!0,B)}finally{W?X():(T=!1,A=null)}}else T=!1}var X;if(typeof _=="function")X=function(){_(U)};else if(typeof MessageChannel<"u"){var j=new MessageChannel,L=j.port2;j.port1.onmessage=U,X=function(){L.postMessage(null)}}else X=function(){g(U,0)};function F(B){A=B,T||(T=!0,X())}function O(B,W){x=g(function(){B(n.unstable_now())},W)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(B){B.callback=null},n.unstable_continueExecution=function(){m||p||(m=!0,F(b))},n.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<B?Math.floor(1e3/B):5},n.unstable_getCurrentPriorityLevel=function(){return f},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(B){switch(f){case 1:case 2:case 3:var W=3;break;default:W=f}var $=f;f=W;try{return B()}finally{f=$}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(B,W){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var $=f;f=B;try{return W()}finally{f=$}},n.unstable_scheduleCallback=function(B,W,$){var te=n.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?te+$:te):$=te,B){case 1:var oe=-1;break;case 2:oe=250;break;case 5:oe=1073741823;break;case 4:oe=1e4;break;default:oe=5e3}return oe=$+oe,B={id:u++,callback:W,priorityLevel:B,startTime:$,expirationTime:oe,sortIndex:-1},$>te?(B.sortIndex=$,e(c,B),t(l)===null&&B===t(c)&&(y?(h(x),x=-1):y=!0,O(M,$-te))):(B.sortIndex=oe,e(l,B),m||p||(m=!0,F(b))),B},n.unstable_shouldYield=C,n.unstable_wrapCallback=function(B){var W=f;return function(){var $=f;f=W;try{return B.apply(this,arguments)}finally{f=$}}}})(x0);v0.exports=x0;var Vx=v0.exports;/**
 * @license React
...
`)}const vb={[Sv]:"Linear",[Mv]:"Reinhard",[Ev]:"Cineon",[Tv]:"ACESFilmic",[Av]:"AgX",[bv]:"Neutral",[wv]:"Custom"};function xb(n,e){const t=vb[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Tl=new k;function yb(){Ye.getLuminanceCoefficients(Tl);const n=Tl.x.toFixed(4),e=Tl.y.toFixed(4),t=Tl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+h);const v=_+g+o,M=_+h+a,b=Hg(r,r.VERTEX_SHADER,v),T=Hg(r,r.FRAGMENT_SHADER,M);r.attachShader(y,b),r.attachShader(y,T),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function A(C){if(n.debug.checkShaderErrors){const U=r.getProgramInfoLog(y)||"",X=r.getShaderInfoLog(b)||"",j=r.getShaderInfoLog(T)||"",L=U.trim(),F=X.trim(),O=j.trim();let B=!0,W=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(B=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,y,b,T);else{const $=Wg(r,b,"vertex"),te=Wg(r,T,"fragment");Ne("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
}`,tR=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],nR=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],Jg=new We,Fo=new k,sf=new k;function iR(n,e,t){let i=new ap;const r=new Je,s=new Je,o=new ft,a=new VE,l=new HE,c={},u=t.maxTextureSize,d={[Yi]:vn,[vn]:Yi,[pi]:pi},f=new Ei({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Je},radius:{value:4}},vertexShader:Qb,fragmentShader:eR}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const m=new Gn;m.setAttribute("position",new un(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new Cn(m,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Bl;let h=this.type;this.render=function(T,A,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||T.length===0)return;this.type===xv&&(Re("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Bl);const R=n.getRenderTarget(),P=n.getActiveCubeFace(),C=n.getActiveMipmapLevel(),U=n.state;U.setBlending(Vi),U.buffers.depth.getReversed()===!0?U.buffers.color.setClear(0,0,0,0):U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const X=h!==this.type;X&&A.traverse(function(j){j.material&&(Array.isArray(j.material)?j.material.forEach(L=>L.needsUpdate=!0):j.material.needsUpdate=!0)});for(let j=0,L=T.length;j<L;j++){const F=T[j],O=F.shadow;if(O===void 0){Re("WebGLShadowMap:",F,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;r.copy(O.mapSize);const B=O.getFrameExtents();r.multiply(B),s.copy(O.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/B.x),r.x=s.x*B.x,O.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/B.y),r.y=s.y*B.y,O.mapSize.y=s.y));const W=n.state.buffers.depth.getReversed();if(O.camera._reversedDepth=W,O.map===null||X===!0){if(O.map!==null&&(O.map.depthTexture!==null&&(O.map.depthTexture.dispose(),O.map.depthTexture=null),O.map.dispose()),this.type===Ho){if(F.isPointLight){Re("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}O.map=new yi(r.x,r.y,{format:is,type:Ki,minFilter:zt,magFilter:zt,generateMipmaps:!1}),O.map.texture.name=F.name+".shadowMap",O.map.depthTexture=new so(r.x,r.y,kn),O.map.depthTexture.name=F.name+".shadowMapDepth",O.map.depthTexture.format=qi,O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Bt,O.map.depthTexture.magFilter=Bt}else F.isPointLight?(O.map=new tx(r.x),O.map.depthTexture=new UE(r.x,Mi)):(O.map=new yi(r.x,r.y),O.map.depthTexture=new so(r.x,r.y,Mi)),O.map.depthTexture.name=F.name+".shadowMap",O.map.depthTexture.format=qi,this.type===Bl?(O.map.depthTexture.compareFunction=W?tp:ep,O.map.depthTexture.minFilter=zt,O.map.depthTexture.magFilter=zt):(O.map.depthTexture.compareFunction=null,O.map.depthTexture.minFilter=Bt,O.map.depthTexture.magFilter=Bt);O.camera.updateProjectionMatrix()}const $=O.map.isWebGLCubeRenderTarget?6:1;for(let te=0;te<$;te++){if(O.map.isWebGLCubeRenderTarget)n.setRenderTarget(O.map,te),n.clear();else{te===0&&(n.setRenderTarget(O.map),n.clear());const oe=O.getViewport(te);o.set(s.x*oe.x,s.y*oe.y,s.x*oe.z,s.y*oe.w),U.viewport(o)}if(F.isPointLight){const oe=O.camera,re=O.matrix,ye=F.distance||oe.far;ye!==oe.far&&(oe.far=ye,oe.updateProjectionMatrix()),Fo.setFromMatrixPosition(F.matrixWorld),oe.position.copy(Fo),sf.copy(oe.position),sf.add(tR[te]),oe.up.copy(nR[te]),oe.lookAt(sf),oe.updateMatrixWorld(),re.makeTranslation(-Fo.x,-Fo.y,-Fo.z),Jg.multiplyMatrices(oe.projectionMatrix,oe.matrixWorldInverse),O._frustum.setFromProjectionMatrix(Jg,oe.coordinateSystem,oe.reversedDepth)}else O.updateMatrices(F);i=O.getFrustum(),M(A,x,O.camera,F,this.type)}O.isPointLightShadow!==!0&&this.type===Ho&&_(O,x),O.needsUpdate=!1}h=this.type,g.needsUpdate=!1,n.setRenderTarget(R,P,C)};function _(T,A){const x=e.update(y);f.defines.VSM_SAMPLES!==T.blurSamples&&(f.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new yi(r.x,r.y,{format:is,type:Ki})),f.uniforms.shadow_pass.value=T.map.depthTexture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(A,null,x,f,y,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(A,null,x,p,y,null)}function v(T,A,x,R){let P=null;const C=x.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(C!==void 0)P=C;else if(P=x.isPointLight===!0?l:a,n.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const U=P.uuid,X=A.uuid;let j=c[U];j===void 0&&(j={},c[U]=j);let L=j[X];L===void 0&&(L=P.clone(),j[X]=L,A.addEventListener("dispose",b)),P=L}if(P.visible=A.visible,P.wireframe=A.wireframe,R===Ho?P.side=A.shadowSide!==null?A.shadowSide:A.side:P.side=A.shadowSide!==null?A.shadowSide:d[A.side],P.alphaMap=A.alphaMap,P.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,P.map=A.map,P.clipShadows=A.clipShadows,P.clippingPlanes=A.clippingPlanes,P.clipIntersection=A.clipIntersection,P.displacementMap=A.displacementMap,P.displacementScale=A.displacementScale,P.displacementBias=A.displacementBias,P.wireframeLinewidth=A.wireframeLinewidth,P.linewidth=A.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const U=n.properties.get(P);U.light=x}return P}function M(T,A,x,R,P){if(T.visible===!1)return;if(T.layers.test(A.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&P===Ho)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,T.matrixWorld);const X=e.update(T),j=T.material;if(Array.isArray(j)){const L=X.groups;for(let F=0,O=L.length;F<O;F++){const B=L[F],W=j[B.materialIndex];if(W&&W.visible){const $=v(T,W,R,P);T.onBeforeShadow(n,T,A,x,X,$,B),n.renderBufferDirect(x,null,X,$,T,B),T.onAfterShadow(n,T,A,x,X,$,B)}}}else if(j.visible){const L=v(T,j,R,P);T.onBeforeShadow(n,T,A,x,X,L,null),n.renderBufferDirect(x,null,X,L,T,null),T.onAfterShadow(n,T,A,x,X,L,null)}}const U=T.children;for(let X=0,j=U.length;X<j;X++)M(U[X],A,x,R,P)}function b(T){T.target.removeEventListener("dispose",b);for(const x in c){const R=c[x],P=T.target.uuid;P in R&&(R[P].dispose(),delete R[P])}}}function rR(n,e){function t(){let I=!1;const ce=new ft;let q=null;const xe=new ft(0,0,0,0);return{setMask:function(de){q!==de&&!I&&(n.colorMask(de,de,de,de),q=de)},setLocked:function(de){I=de},setClear:function(de,ee,Ce,Be,Rt){Rt===!0&&(de*=Be,ee*=Be,Ce*=Be),ce.set(de,ee,Ce,Be),xe.equals(ce)===!1&&(n.clearColor(de,ee,Ce,Be),xe.copy(ce))},reset:function(){I=!1,q=null,xe.set(-1,0,0,0)}}}function i(){let I=!1,ce=!1,q=null,xe=null,de=null;return{setReversed:function(ee){if(ce!==ee){const Ce=e.get("EXT_clip_control");ee?Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.ZERO_TO_ONE_EXT):Ce.clipControlEXT(Ce.LOWER_LEFT_EXT,Ce.NEGATIVE_ONE_TO_ONE_EXT),ce=ee;const Be=de;de=null,this.setClear(Be)}},getReversed:function(){return ce},setTest:function(ee){ee?ie(n.DEPTH_TEST):we(n.DEPTH_TEST)},setMask:function(ee){q!==ee&&!I&&(n.depthMask(ee),q=ee)},setFunc:function(ee){if(ce&&(ee=zM[ee]),xe!==ee){switch(ee){case sd:n.depthFunc(n.NEVER);break;case od:n.depthFunc(n.ALWAYS);break;case ad:n.depthFunc(n.LESS);break;case to:n.depthFunc(n.LEQUAL);break;case ld:n.depthFunc(n.EQUAL);break;case cd:n.depthFunc(n.GEQUAL);break;case ud:n.depthFunc(n.GREATER);break;case fd:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}xe=ee}},setLocked:function(ee){I=ee},setClear:function(ee){de!==ee&&(de=ee,ce&&(ee=1-ee),n.clearDepth(ee))},reset:function(){I=!1,q=null,xe=null,de=null,ce=!1}}}function r(){let I=!1,ce=null,q=null,xe=null,de=null,ee=null,Ce=null,Be=null,Rt=null;return{setTest:function(at){I||(at?ie(n.STENCIL_TEST):we(n.STENCIL_TEST))},setMask:function(at){ce!==at&&!I&&(n.stencilMask(at),ce=at)},setFunc:function(at,bi,si){(q!==at||xe!==bi||de!==si)&&(n.stencilFunc(at,bi,si),q=at,xe=bi,de=si)},setOp:function(at,bi,si){(ee!==at||Ce!==bi||Be!==si)&&(n.stencilOp(at,bi,si),ee=at,Ce=bi,Be=si)},setLocked:function(at){I=at},setClear:function(at){Rt!==at&&(n.clearStencil(at),Rt=at)},reset:function(){I=!1,ce=null,q=null,xe=null,de=null,ee=null,Ce=null,Be=null,Rt=null}}}const s=new t,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},d={},f={},p=new WeakMap,m=[],y=null,g=!1,h=null,_=null,v=null,M=null,b=null,T=null,A=null,x=new ke(0,0,0),R=0,P=!1,C=null,U=null,X=null,j=null,L=null;const F=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,B=0;const W=n.getParameter(n.VERSION);W.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(W)[1]),O=B>=1):W.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),O=B>=2);let $=null,te={};const oe=n.getParameter(n.SCISSOR_BOX),re=n.getParameter(n.VIEWPORT),ye=new ft().fromArray(oe),Ae=new ft().fromArray(re);function Y(I,ce,q,xe){const de=new Uint8Array(4),ee=n.createTexture();n.bindTexture(I,ee),n.texParameteri(I,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(I,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ce=0;Ce<q;Ce++)I===n.TEXTURE_3D||I===n.TEXTURE_2D_ARRAY?n.texImage3D(ce,0,n.RGBA,1,1,xe,0,n.RGBA,n.UNSIGNED_BYTE,de):n.texImage2D(ce+Ce,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,de);return ee}const ue={};ue[n.TEXTURE_2D]=Y(n.TEXTURE_2D,n.TEXTURE_2D,1),ue[n.TEXTURE_CUBE_MAP]=Y(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ue[n.TEXTURE_2D_ARRAY]=Y(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ue[n.TEXTURE_3D]=Y(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ie(n.DEPTH_TEST),o.setFunc(to),Ut(!1),yt(Um),ie(n.CULL_FACE),mt(Vi);function ie(I){u[I]!==!0&&(n.enable(I),u[I]=!0)}function we(I){u[I]!==!1&&(n.disable(I),u[I]=!1)}function Ie(I,ce){return f[I]!==ce?(n.bindFramebuffer(I,ce),f[I]=ce,I===n.DRAW_FRAMEBUFFER&&(f[n.FRAMEBUFFER]=ce),I===n.FRAMEBUFFER&&(f[n.DRAW_FRAMEBUFFER]=ce),!0):!1}function De(I,ce){let q=m,xe=!1;if(I){q=p.get(ce),q===void 0&&(q=[],p.set(ce,q));const de=I.textures;if(q.length!==de.length||q[0]!==n.COLOR_ATTACHMENT0){for(let ee=0,Ce=de.length;ee<Ce;ee++)q[ee]=n.COLOR_ATTACHMENT0+ee;q.length=de.length,xe=!0}}else q[0]!==n.BACK&&(q[0]=n.BACK,xe=!0);xe&&n.drawBuffers(q)}function xt(I){return y!==I?(n.useProgram(I),y=I,!0):!1}const $e={[Hr]:n.FUNC_ADD,[oM]:n.FUNC_SUBTRACT,[aM]:n.FUNC_REVERSE_SUBTRACT};$e[lM]=n.MIN,$e[cM]=n.MAX;const ot={[uM]:n.ZERO,[fM]:n.ONE,[dM]:n.SRC_COLOR,[id]:n.SRC_ALPHA,[vM]:n.SRC_ALPHA_SATURATE,[gM]:n.DST_COLOR,[pM]:n.DST_ALPHA,[hM]:n.ONE_MINUS_SRC_COLOR,[rd]:n.ONE_MINUS_SRC_ALPHA,[_M]:n.ONE_MINUS_DST_COLOR,[mM]:n.ONE_MINUS_DST_ALPHA,[xM]:n.CONSTANT_COLOR,[yM]:n.ONE_MINUS_CONSTANT_COLOR,[SM]:n.CONSTANT_ALPHA,[MM]:n.ONE_MINUS_CONSTANT_ALPHA};function mt(I,ce,q,xe,de,ee,Ce,Be,Rt,at){if(I===Vi){g===!0&&(we(n.BLEND),g=!1);return}if(g===!1&&(ie(n.BLEND),g=!0),I!==sM){if(I!==h||at!==P){if((_!==Hr||b!==Hr)&&(n.blendEquation(n.FUNC_ADD),_=Hr,b=Hr),at)switch(I){case Xs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fm:n.blendFunc(n.ONE,n.ONE);break;case Om:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case km:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Ne("WebGLState: Invalid blending: ",I);break}else switch(I){case Xs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Fm:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Om:Ne("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case km:Ne("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ne("WebGLState: Invalid blending: ",I);break}v=null,M=null,T=null,A=null,x.set(0,0,0),R=0,h=I,P=at}return}de=de||ce,ee=ee||q,Ce=Ce||xe,(ce!==_||de!==b)&&(n.blendEquationSeparate($e[ce],$e[de]),_=ce,b=de),(q!==v||xe!==M||ee!==T||Ce!==A)&&(n.blendFuncSeparate(ot[q],ot[xe],ot[ee],ot[Ce]),v=q,M=xe,T=ee,A=Ce),(Be.equals(x)===!1||Rt!==R)&&(n.blendColor(Be.r,Be.g,Be.b,Rt),x.copy(Be),R=Rt),h=I,P=!1}function je(I,ce){I.side===pi?we(n.CULL_FACE):ie(n.CULL_FACE);let q=I.side===vn;ce&&(q=!q),Ut(q),I.blending===Xs&&I.transparent===!1?mt(Vi):mt(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),o.setFunc(I.depthFunc),o.setTest(I.depthTest),o.setMask(I.depthWrite),s.setMask(I.colorWrite);const xe=I.stencilWrite;a.setTest(xe),xe&&(a.setMask(I.stencilWriteMask),a.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),a.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),N(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?ie(n.SAMPLE_ALPHA_TO_COVERAGE):we(n.SAMPLE_ALPHA_TO_COVERAGE)}function Ut(I){C!==I&&(I?n.frontFace(n.CW):n.frontFace(n.CCW),C=I)}function yt(I){I!==iM?(ie(n.CULL_FACE),I!==U&&(I===Um?n.cullFace(n.BACK):I===rM?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):we(n.CULL_FACE),U=I}function xn(I){I!==X&&(O&&n.lineWidth(I),X=I)}function N(I,ce,q){I?(ie(n.POLYGON_OFFSET_FILL),(j!==ce||L!==q)&&(j=ce,L=q,o.getReversed()&&(ce=-ce),n.polygonOffset(ce,q))):we(n.POLYGON_OFFSET_FILL)}function Ft(I){I?ie(n.SCISSOR_TEST):we(n.SCISSOR_TEST)}function Ze(I){I===void 0&&(I=n.TEXTURE0+F-1),$!==I&&(n.activeTexture(I),$=I)}function dt(I,ce,q){q===void 0&&($===null?q=n.TEXTURE0+F-1:q=$);let xe=te[q];xe===void 0&&(xe={type:void 0,texture:void 0},te[q]=xe),(xe.type!==I||xe.texture!==ce)&&($!==q&&(n.activeTexture(q),$=q),n.bindTexture(I,ce||ue[I]),xe.type=I,xe.texture=ce)}function pe(){const I=te[$];I!==void 0&&I.type!==void 0&&(n.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function wt(){try{n.compressedTexImage2D(...arguments)}catch(I){Ne("WebGLState:",I)}}function w(){try{n.compressedTexImage3D(...arguments)}catch(I){Ne("WebGLState:",I)}}function S(){try{n.texSubImage2D(...arguments)}catch(I){Ne("WebGLState:",I)}}function z(){try{n.texSubImage3D(...arguments)}catch(I){Ne("WebGLState:",I)}}function Z(){try{n.compressedTexSubImage2D(...arguments)}catch(I){Ne("WebGLState:",I)}}function ne(){try{n.compressedTexSubImage3D(...arguments)}catch(I){Ne("WebGLState:",I)}}function ae(){try{n.texStorage2D(...arguments)}catch(I){Ne("WebGLState:",I)}}function he(){try{n.texStorage3D(...arguments)}catch(I){Ne("WebGLState:",I)}}function K(){try{n.texImage2D(...arguments)}catch(I){Ne("WebGLState:",I)}}function J(){try{n.texImage3D(...arguments)}catch(I){Ne("WebGLState:",I)}}function ve(I){return d[I]!==void 0?d[I]:n.getParameter(I)}function Me(I,ce){d[I]!==ce&&(n.pixelStorei(I,ce),d[I]=ce)}function fe(I){ye.equals(I)===!1&&(n.scissor(I.x,I.y,I.z,I.w),ye.copy(I))}function le(I){Ae.equals(I)===!1&&(n.viewport(I.x,I.y,I.z,I.w),Ae.copy(I))}function Fe(I,ce){let q=c.get(ce);q===void 0&&(q=new WeakMap,c.set(ce,q));let xe=q.get(I);xe===void 0&&(xe=n.getUniformBlockIndex(ce,I.name),q.set(I,xe))}function Ve(I,ce){const xe=c.get(ce).get(I);l.get(ce)!==xe&&(n.uniformBlockBinding(ce,xe,I.__bindingPointIndex),l.set(ce,xe))}function tt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},d={},$=null,te={},f={},p=new WeakMap,m=[],y=null,g=!1,h=null,_=null,v=null,M=null,b=null,T=null,A=null,x=new ke(0,0,0),R=0,P=!1,C=null,U=null,X=null,j=null,L=null,ye.set(0,0,n.canvas.width,n.canvas.height),Ae.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:ie,disable:we,bindFramebuffer:Ie,drawBuffers:De,useProgram:xt,setBlending:mt,setMaterial:je,setFlipSided:Ut,setCullFace:yt,setLineWidth:xn,setPolygonOffset:N,setScissorTest:Ft,activeTexture:Ze,bindTexture:dt,unbindTexture:pe,compressedTexImage2D:wt,compressedTexImage3D:w,texImage2D:K,texImage3D:J,pixelStorei:Me,getParameter:ve,updateUBOMapping:Fe,uniformBlockBinding:Ve,texStorage2D:ae,texStorage3D:he,texSubImage2D:S,texSubImage3D:z,compressedTexSubImage2D:Z,compressedTexSubImage3D:ne,scissor:fe,viewport:le,reset:tt}}function sR(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Je,u=new WeakMap,d=new Set;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(w,S){return m?new OffscreenCanvas(w,S):wa("canvas")}function g(w,S,z){let Z=1;const ne=wt(w);if((ne.width>z||ne.height>z)&&(Z=z/Math.max(ne.width,ne.height)),Z<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const ae=Math.floor(Z*ne.width),he=Math.floor(Z*ne.height);f===void 0&&(f=y(ae,he));const K=S?y(ae,he):f;return K.width=ae,K.height=he,K.getContext("2d").drawImage(w,0,0,ae,he),Re("WebGLRenderer: Texture has been resized from ("+ne.width+"x"+ne.height+") to ("+ae+"x"+he+")."),K}else return"data"in w&&Re("WebGLRenderer: Image in DataTexture is too big ("+ne.width+"x"+ne.height+")."),w;return w}function h(w){return w.generateMipmaps}function _(w){n.generateMipmap(w)}function v(w){return w.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?n.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function M(w,S,z,Z,ne,ae=!1){if(w!==null){if(n[w]!==void 0)return n[w];Re("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let he;Z&&(he=e.get("EXT_texture_norm16"),he||Re("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let K=S;if(S===n.RED&&(z===n.FLOAT&&(K=n.R32F),z===n.HALF_FLOAT&&(K=n.R16F),z===n.UNSIGNED_BYTE&&(K=n.R8),z===n.UNSIGNED_SHORT&&he&&(K=he.R16_EXT),z===n.SHORT&&he&&(K=he.R16_SNORM_EXT)),S===n.RED_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.R8UI),z===n.UNSIGNED_SHORT&&(K=n.R16UI),z===n.UNSIGNED_INT&&(K=n.R32UI),z===n.BYTE&&(K=n.R8I),z===n.SHORT&&(K=n.R16I),z===n.INT&&(K=n.R32I)),S===n.RG&&(z===n.FLOAT&&(K=n.RG32F),z===n.HALF_FLOAT&&(K=n.RG16F),z===n.UNSIGNED_BYTE&&(K=n.RG8),z===n.UNSIGNED_SHORT&&he&&(K=he.RG16_EXT),z===n.SHORT&&he&&(K=he.RG16_SNORM_EXT)),S===n.RG_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.RG8UI),z===n.UNSIGNED_SHORT&&(K=n.RG16UI),z===n.UNSIGNED_INT&&(K=n.RG32UI),z===n.BYTE&&(K=n.RG8I),z===n.SHORT&&(K=n.RG16I),z===n.INT&&(K=n.RG32I)),S===n.RGB_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.RGB8UI),z===n.UNSIGNED_SHORT&&(K=n.RGB16UI),z===n.UNSIGNED_INT&&(K=n.RGB32UI),z===n.BYTE&&(K=n.RGB8I),z===n.SHORT&&(K=n.RGB16I),z===n.INT&&(K=n.RGB32I)),S===n.RGBA_INTEGER&&(z===n.UNSIGNED_BYTE&&(K=n.RGBA8UI),z===n.UNSIGNED_SHORT&&(K=n.RGBA16UI),z===n.UNSIGNED_INT&&(K=n.RGBA32UI),z===n.BYTE&&(K=n.RGBA8I),z===n.SHORT&&(K=n.RGBA16I),z===n.INT&&(K=n.RGBA32I)),S===n.RGB&&(z===n.UNSIGNED_SHORT&&he&&(K=he.RGB16_EXT),z===n.SHORT&&he&&(K=he.RGB16_SNORM_EXT),z===n.UNSIGNED_INT_5_9_9_9_REV&&(K=n.RGB9_E5),z===n.UNSIGNED_INT_10F_11F_11F_REV&&(K=n.R11F_G11F_B10F)),S===n.RGBA){const J=ae?yc:Ye.getTransfer(ne);z===n.FLOAT&&(K=n.RGBA32F),z===n.HALF_FLOAT&&(K=n.RGBA16F),z===n.UNSIGNED_BYTE&&(K=J===nt?n.SRGB8_ALPHA8:n.RGBA8),z===n.UNSIGNED_SHORT&&he&&(K=he.RGBA16_EXT),z===n.SHORT&&he&&(K=he.RGBA16_SNORM_EXT),z===n.UNSIGNED_SHORT_4_4_4_4&&(K=n.RGBA4),z===n.UNSIGNED_SHORT_5_5_5_1&&(K=n.RGB5_A1)}return(K===n.R16F||K===n.R32F||K===n.RG16F||K===n.RG32F||K===n.RGBA16F||K===n.RGBA32F)&&e.get("EXT_color_buffer_float"),K}function b(w,S){let z;return w?S===null||S===Mi||S===Sa?z=n.DEPTH24_STENCIL8:S===kn?z=n.DEPTH32F_STENCIL8:S===ya&&(z=n.DEPTH24_STENCIL8,Re("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===Mi||S===Sa?z=n.DEPTH_COMPONENT24:S===kn?z=n.DEPTH_COMPONENT32F:S===ya&&(z=n.DEPTH_COMPONENT16),z}function T(w,S){return h(w)===!0||w.isFramebufferTexture&&w.minFilter!==Bt&&w.minFilter!==zt?Math.log2(Math.max(S.width,S.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?S.mipmaps.length:1}function A(w){const S=w.target;S.removeEventListener("dispose",A),R(S),S.isVideoTexture&&u.delete(S),S.isHTMLTexture&&d.delete(S)}function x(w){const S=w.target;S.removeEventListener("dispose",x),C(S)}function R(w){const S=i.get(w);if(S.__webglInit===void 0)return;const z=w.source,Z=p.get(z);if(Z){const ne=Z[S.__cacheKey];ne.usedTimes--,ne.usedTimes===0&&P(w),Object.keys(Z).length===0&&p.delete(z)}i.remove(w)}function P(w){const S=i.get(w);n.deleteTexture(S.__webglTexture);const z=w.source,Z=p.get(z);delete Z[S.__cacheKey],o.memory.textures--}function C(w){const S=i.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),i.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let Z=0;Z<6;Z++){if(Array.isArray(S.__webglFramebuffer[Z]))for(let ne=0;ne<S.__webglFramebuffer[Z].length;ne++)n.deleteFramebuffer(S.__webglFramebuffer[Z][ne]);else n.deleteFramebuffer(S.__webglFramebuffer[Z]);S.__webglDepthbuffer&&n.deleteRenderbuffer(S.__webglDepthbuffer[Z])}else{if(Array.isArray(S.__webglFramebuffer))for(let Z=0;Z<S.__webglFramebuffer.length;Z++)n.deleteFramebuffer(S.__webglFramebuffer[Z]);else n.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&n.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&n.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let Z=0;Z<S.__webglColorRenderbuffer.length;Z++)S.__webglColorRenderbuffer[Z]&&n.deleteRenderbuffer(S.__webglColorRenderbuffer[Z]);S.__webglDepthRenderbuffer&&n.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const z=w.textures;for(let Z=0,ne=z.length;Z<ne;Z++){const ae=i.get(z[Z]);ae.__webglTexture&&(n.deleteTexture(ae.__webglTexture),o.memory.textures--),i.remove(z[Z])}i.remove(w)}let U=0;function X(){U=0}function j(){return U}function L(w){U=w}function F(){const w=U;return w>=r.maxTextures&&Re("WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),U+=1,w}function O(w){const S=[];return S.push(w.wrapS),S.push(w.wrapT),S.push(w.wrapR||0),S.push(w.magFilter),S.push(w.minFilter),S.push(w.anisotropy),S.push(w.internalFormat),S.push(w.format),S.push(w.type),S.push(w.generateMipmaps),S.push(w.premultiplyAlpha),S.push(w.flipY),S.push(w.unpackAlignment),S.push(w.colorSpace),S.join()}function B(w,S){const z=i.get(w);if(w.isVideoTexture&&dt(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&z.__version!==w.version){const Z=w.image;if(Z===null)Re("WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)Re("WebGLRenderer: Texture marked for update but image is incomplete");else{we(z,w,S);return}}else w.isExternalTexture&&(z.__webglTexture=w.sourceTexture?w.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,z.__webglTexture,n.TEXTURE0+S)}function W(w,S){const z=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){we(z,w,S);return}else w.isExternalTexture&&(z.__webglTexture=w.sourceTexture?w.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,z.__webglTexture,n.TEXTURE0+S)}function $(w,S){const z=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&z.__version!==w.version){we(z,w,S);return}t.bindTexture(n.TEXTURE_3D,z.__webglTexture,n.TEXTURE0+S)}function te(w,S){const z=i.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&z.__version!==w.version){Ie(z,w,S);return}t.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture,n.TEXTURE0+S)}const oe={[io]:n.REPEAT,[mi]:n.CLAMP_TO_EDGE,[_c]:n.MIRRORED_REPEAT},re={[Bt]:n.NEAREST,[Cv]:n.NEAREST_MIPMAP_NEAREST,[Go]:n.NEAREST_MIPMAP_LINEAR,[zt]:n.LINEAR,[zl]:n.LINEAR_MIPMAP_NEAREST,[ki]:n.LINEAR_MIPMAP_LINEAR},ye={[PM]:n.NEVER,[UM]:n.ALWAYS,[LM]:n.LESS,[ep]:n.LEQUAL,[IM]:n.EQUAL,[tp]:n.GEQUAL,[NM]:n.GREATER,[DM]:n.NOTEQUAL};function Ae(w,S){if(S.type===kn&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===zt||S.magFilter===zl||S.magFilter===Go||S.magFilter===ki||S.minFilter===zt||S.minFilter===zl||S.minFilter===Go||S.minFilter===ki)&&Re("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(w,n.TEXTURE_WRAP_S,oe[S.wrapS]),n.texParameteri(w,n.TEXTURE_WRAP_T,oe[S.wrapT]),(w===n.TEXTURE_3D||w===n.TEXTURE_2D_ARRAY)&&n.texParameteri(w,n.TEXTURE_WRAP_R,oe[S.wrapR]),n.texParameteri(w,n.TEXTURE_MAG_FILTER,re[S.magFilter]),n.texParameteri(w,n.TEXTURE_MIN_FILTER,re[S.minFilter]),S.compareFunction&&(n.texParameteri(w,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(w,n.TEXTURE_COMPARE_FUNC,ye[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Bt||S.minFilter!==Go&&S.minFilter!==ki||S.type===kn&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");n.texParameterf(w,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function Y(w,S){let z=!1;w.__webglInit===void 0&&(w.__webglInit=!0,S.addEventListener("dispose",A));const Z=S.source;let ne=p.get(Z);ne===void 0&&(ne={},p.set(Z,ne));const ae=O(S);if(ae!==w.__cacheKey){ne[ae]===void 0&&(ne[ae]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,z=!0),ne[ae].usedTimes++;const he=ne[w.__cacheKey];he!==void 0&&(ne[w.__cacheKey].usedTimes--,he.usedTimes===0&&P(S)),w.__cacheKey=ae,w.__webglTexture=ne[ae].texture}return z}function ue(w,S,z){return Math.floor(Math.floor(w/z)/S)}function ie(w,S,z,Z){const ae=w.updateRanges;if(ae.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,S.width,S.height,z,Z,S.data);else{ae.sort((Me,fe)=>Me.start-fe.start);let he=0;for(let Me=1;Me<ae.length;Me++){const fe=ae[he],le=ae[Me],Fe=fe.start+fe.count,Ve=ue(le.start,S.width,4),tt=ue(fe.start,S.width,4);le.start<=Fe+1&&Ve===tt&&ue(le.start+le.count-1,S.width,4)===Ve?fe.count=Math.max(fe.count,le.start+le.count-fe.start):(++he,ae[he]=le)}ae.length=he+1;const K=t.getParameter(n.UNPACK_ROW_LENGTH),J=t.getParameter(n.UNPACK_SKIP_PIXELS),ve=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,S.width);for(let Me=0,fe=ae.length;Me<fe;Me++){const le=ae[Me],Fe=Math.floor(le.start/4),Ve=Math.ceil(le.count/4),tt=Fe%S.width,I=Math.floor(Fe/S.width),ce=Ve,q=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,tt),t.pixelStorei(n.UNPACK_SKIP_ROWS,I),t.texSubImage2D(n.TEXTURE_2D,0,tt,I,ce,q,z,Z,S.data)}w.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,K),t.pixelStorei(n.UNPACK_SKIP_PIXELS,J),t.pixelStorei(n.UNPACK_SKIP_ROWS,ve)}}function we(w,S,z){let Z=n.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(Z=n.TEXTURE_2D_ARRAY),S.isData3DTexture&&(Z=n.TEXTURE_3D);const ne=Y(w,S),ae=S.source;t.bindTexture(Z,w.__webglTexture,n.TEXTURE0+z);const he=i.get(ae);if(ae.version!==he.__version||ne===!0){if(t.activeTexture(n.TEXTURE0+z),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){const q=Ye.getPrimaries(Ye.workingColorSpace),xe=S.colorSpace===hr?null:Ye.getPrimaries(S.colorSpace),de=S.colorSpace===hr||q===xe?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,de)}t.pixelStorei(n.UNPACK_ALIGNMENT,S.unpackAlignment);let J=g(S.image,!1,r.maxTextureSize);J=pe(S,J);const ve=s.convert(S.format,S.colorSpace),Me=s.convert(S.type);let fe=M(S.internalFormat,ve,Me,S.normalized,S.colorSpace,S.isVideoTexture);Ae(Z,S);let le;const Fe=S.mipmaps,Ve=S.isVideoTexture!==!0,tt=he.__version===void 0||ne===!0,I=ae.dataReady,ce=T(S,J);if(S.isDepthTexture)fe=b(S.format===Yr,S.type),tt&&(Ve?t.texStorage2D(n.TEXTURE_2D,1,fe,J.width,J.height):t.texImage2D(n.TEXTURE_2D,0,fe,J.width,J.height,0,ve,Me,null));else if(S.isDataTexture)if(Fe.length>0){Ve&&tt&&t.texStorage2D(n.TEXTURE_2D,ce,fe,Fe[0].width,Fe[0].height);for(let q=0,xe=Fe.length;q<xe;q++)le=Fe[q],Ve?I&&t.texSubImage2D(n.TEXTURE_2D,q,0,0,le.width,le.height,ve,Me,le.data):t.texImage2D(n.TEXTURE_2D,q,fe,le.width,le.height,0,ve,Me,le.data);S.generateMipmaps=!1}else Ve?(tt&&t.texStorage2D(n.TEXTURE_2D,ce,fe,J.width,J.height),I&&ie(S,J,ve,Me)):t.texImage2D(n.TEXTURE_2D,0,fe,J.width,J.height,0,ve,Me,J.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ve&&tt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ce,fe,Fe[0].width,Fe[0].height,J.depth);for(let q=0,xe=Fe.length;q<xe;q++)if(le=Fe[q],S.format!==Bn)if(ve!==null)if(Ve){if(I)if(S.layerUpdates.size>0){const de=Cg(le.width,le.height,S.format,S.type);for(const ee of S.layerUpdates){const Ce=le.data.subarray(ee*de/le.data.BYTES_PER_ELEMENT,(ee+1)*de/le.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,q,0,0,ee,le.width,le.height,1,ve,Ce)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,q,0,0,0,le.width,le.height,J.depth,ve,le.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,q,fe,le.width,le.height,J.depth,0,le.data,0,0);else Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ve?I&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,q,0,0,0,le.width,le.height,J.depth,ve,Me,le.data):t.texImage3D(n.TEXTURE_2D_ARRAY,q,fe,le.width,le.height,J.depth,0,ve,Me,le.data)}else{Ve&&tt&&t.texStorage2D(n.TEXTURE_2D,ce,fe,Fe[0].width,Fe[0].height);for(let q=0,xe=Fe.length;q<xe;q++)le=Fe[q],S.format!==Bn?ve!==null?Ve?I&&t.compressedTexSubImage2D(n.TEXTURE_2D,q,0,0,le.width,le.height,ve,le.data):t.compressedTexImage2D(n.TEXTURE_2D,q,fe,le.width,le.height,0,le.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?I&&t.texSubImage2D(n.TEXTURE_2D,q,0,0,le.width,le.height,ve,Me,le.data):t.texImage2D(n.TEXTURE_2D,q,fe,le.width,le.height,0,ve,Me,le.data)}else if(S.isDataArrayTexture)if(Ve){if(tt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ce,fe,J.width,J.height,J.depth),I)if(S.layerUpdates.size>0){const q=Cg(J.width,J.height,S.format,S.type);for(const xe of S.layerUpdates){const de=J.data.subarray(xe*q/J.data.BYTES_PER_ELEMENT,(xe+1)*q/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,xe,J.width,J.height,1,ve,Me,de)}S.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ve,Me,J.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,fe,J.width,J.height,J.depth,0,ve,Me,J.data);else if(S.isData3DTexture)Ve?(tt&&t.texStorage3D(n.TEXTURE_3D,ce,fe,J.width,J.height,J.depth),I&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ve,Me,J.data)):t.texImage3D(n.TEXTURE_3D,0,fe,J.width,J.height,J.depth,0,ve,Me,J.data);else if(S.isFramebufferTexture){if(tt)if(Ve)t.texStorage2D(n.TEXTURE_2D,ce,fe,J.width,J.height);else{let q=J.width,xe=J.height;for(let de=0;de<ce;de++)t.texImage2D(n.TEXTURE_2D,de,fe,q,xe,0,ve,Me,null),q>>=1,xe>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in n){const q=n.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),J.parentNode!==q){q.appendChild(J),d.add(S),q.onpaint=Be=>{const Rt=Be.changedElements;for(const at of d)Rt.includes(at.image)&&(at.needsUpdate=!0)},q.requestPaint();return}const xe=0,de=n.RGBA,ee=n.RGBA,Ce=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,xe,de,ee,Ce,J),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(Ve&&tt){const q=wt(Fe[0]);t.texStorage2D(n.TEXTURE_2D,ce,fe,q.width,q.height)}for(let q=0,xe=Fe.length;q<xe;q++)le=Fe[q],Ve?I&&t.texSubImage2D(n.TEXTURE_2D,q,0,0,ve,Me,le):t.texImage2D(n.TEXTURE_2D,q,fe,ve,Me,le);S.generateMipmaps=!1}else if(Ve){if(tt){const q=wt(J);t.texStorage2D(n.TEXTURE_2D,ce,fe,q.width,q.height)}I&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ve,Me,J)}else t.texImage2D(n.TEXTURE_2D,0,fe,ve,Me,J);h(S)&&_(Z),he.__version=ae.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function Ie(w,S,z){if(S.image.length!==6)return;const Z=Y(w,S),ne=S.source;t.bindTexture(n.TEXTURE_CUBE_MAP,w.__webglTexture,n.TEXTURE0+z);const ae=i.get(ne);if(ne.version!==ae.__version||Z===!0){t.activeTexture(n.TEXTURE0+z);const he=Ye.getPrimaries(Ye.workingColorSpace),K=S.colorSpace===hr?null:Ye.getPrimaries(S.colorSpace),J=S.colorSpace===hr||he===K?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const ve=S.isCompressedTexture||S.image[0].isCompressedTexture,Me=S.image[0]&&S.image[0].isDataTexture,fe=[];for(let ee=0;ee<6;ee++)!ve&&!Me?fe[ee]=g(S.image[ee],!0,r.maxCubemapSize):fe[ee]=Me?S.image[ee].image:S.image[ee],fe[ee]=pe(S,fe[ee]);const le=fe[0],Fe=s.convert(S.format,S.colorSpace),Ve=s.convert(S.type),tt=M(S.internalFormat,Fe,Ve,S.normalized,S.colorSpace),I=S.isVideoTexture!==!0,ce=ae.__version===void 0||Z===!0,q=ne.dataReady;let xe=T(S,le);Ae(n.TEXTURE_CUBE_MAP,S);let de;if(ve){I&&ce&&t.texStorage2D(n.TEXTURE_CUBE_MAP,xe,tt,le.width,le.height);for(let ee=0;ee<6;ee++){de=fe[ee].mipmaps;for(let Ce=0;Ce<de.length;Ce++){const Be=de[Ce];S.format!==Bn?Fe!==null?I?q&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce,0,0,Be.width,Be.height,Fe,Be.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce,tt,Be.width,Be.height,0,Be.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?q&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce,0,0,Be.width,Be.height,Fe,Ve,Be.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce,tt,Be.width,Be.height,0,Fe,Ve,Be.data)}}}else{if(de=S.mipmaps,I&&ce){de.length>0&&xe++;const ee=wt(fe[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,xe,tt,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Me){I?q&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,fe[ee].width,fe[ee].height,Fe,Ve,fe[ee].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,tt,fe[ee].width,fe[ee].height,0,Fe,Ve,fe[ee].data);for(let Ce=0;Ce<de.length;Ce++){const Rt=de[Ce].image[ee].image;I?q&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce+1,0,0,Rt.width,Rt.height,Fe,Ve,Rt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce+1,tt,Rt.width,Rt.height,0,Fe,Ve,Rt.data)}}else{I?q&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Fe,Ve,fe[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,tt,Fe,Ve,fe[ee]);for(let Ce=0;Ce<de.length;Ce++){const Be=de[Ce];I?q&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce+1,0,0,Fe,Ve,Be.image[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ce+1,tt,Fe,Ve,Be.image[ee])}}}h(S)&&_(n.TEXTURE_CUBE_MAP),ae.__version=ne.version,S.onUpdate&&S.onUpdate(S)}w.__version=S.version}function De(w,S,z,Z,ne,ae){const he=s.convert(z.format,z.colorSpace),K=s.convert(z.type),J=M(z.internalFormat,he,K,z.normalized,z.colorSpace),ve=i.get(S),Me=i.get(z);if(Me.__renderTarget=S,!ve.__hasExternalTextures){const fe=Math.max(1,S.width>>ae),le=Math.max(1,S.height>>ae);ne===n.TEXTURE_3D||ne===n.TEXTURE_2D_ARRAY?t.texImage3D(ne,ae,J,fe,le,S.depth,0,he,K,null):t.texImage2D(ne,ae,J,fe,le,0,he,K,null)}t.bindFramebuffer(n.FRAMEBUFFER,w),Ze(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Z,ne,Me.__webglTexture,0,Ft(S)):(ne===n.TEXTURE_2D||ne>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ne<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Z,ne,Me.__webglTexture,ae),t.bindFramebuffer(n.FRAMEBUFFER,null)}function xt(w,S,z){if(n.bindRenderbuffer(n.RENDERBUFFER,w),S.depthBuffer){const Z=S.depthTexture,ne=Z&&Z.isDepthTexture?Z.type:null,ae=b(S.stencilBuffer,ne),he=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Ze(S)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ft(S),ae,S.width,S.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ft(S),ae,S.width,S.height):n.renderbufferStorage(n.RENDERBUFFER,ae,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,w)}else{const Z=S.textures;for(let ne=0;ne<Z.length;ne++){const ae=Z[ne],he=s.convert(ae.format,ae.colorSpace),K=s.convert(ae.type),J=M(ae.internalFormat,he,K,ae.normalized,ae.colorSpace);Ze(S)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ft(S),J,S.width,S.height):z?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ft(S),J,S.width,S.height):n.renderbufferStorage(n.RENDERBUFFER,J,S.width,S.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function $e(w,S,z){const Z=S.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,w),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ne=i.get(S.depthTexture);if(ne.__renderTarget=S,(!ne.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),Z){if(ne.__webglInit===void 0&&(ne.__webglInit=!0,S.depthTexture.addEventListener("dispose",A)),ne.__webglTexture===void 0){ne.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,ne.__webglTexture),Ae(n.TEXTURE_CUBE_MAP,S.depthTexture);const ve=s.convert(S.depthTexture.format),Me=s.convert(S.depthTexture.type);let fe;S.depthTexture.format===qi?fe=n.DEPTH_COMPONENT24:S.depthTexture.format===Yr&&(fe=n.DEPTH24_STENCIL8);for(let le=0;le<6;le++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,fe,S.width,S.height,0,ve,Me,null)}}else B(S.depthTexture,0);const ae=ne.__webglTexture,he=Ft(S),K=Z?n.TEXTURE_CUBE_MAP_POSITIVE_X+z:n.TEXTURE_2D,J=S.depthTexture.format===Yr?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(S.depthTexture.format===qi)Ze(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,J,K,ae,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,J,K,ae,0);else if(S.depthTexture.format===Yr)Ze(S)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,J,K,ae,0,he):n.framebufferTexture2D(n.FRAMEBUFFER,J,K,ae,0);else throw new Error("Unknown depthTexture format")}function ot(w){const S=i.get(w),z=w.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==w.depthTexture){const Z=w.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),Z){const ne=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,Z.removeEventListener("dispose",ne)};Z.addEventListener("dispose",ne),S.__depthDisposeCallback=ne}S.__boundDepthTexture=Z}if(w.depthTexture&&!S.__autoAllocateDepthBuffer)if(z)for(let Z=0;Z<6;Z++)$e(S.__webglFramebuffer[Z],w,Z);else{const Z=w.texture.mipmaps;Z&&Z.length>0?$e(S.__webglFramebuffer[0],w,0):$e(S.__webglFramebuffer,w,0)}else if(z){S.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)if(t.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer[Z]),S.__webglDepthbuffer[Z]===void 0)S.__webglDepthbuffer[Z]=n.createRenderbuffer(),xt(S.__webglDepthbuffer[Z],w,!1);else{const ne=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=S.__webglDepthbuffer[Z];n.bindRenderbuffer(n.RENDERBUFFER,ae),n.framebufferRenderbuffer(n.FRAMEBUFFER,ne,n.RENDERBUFFER,ae)}}else{const Z=w.texture.mipmaps;if(Z&&Z.length>0?t.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=n.createRenderbuffer(),xt(S.__webglDepthbuffer,w,!1);else{const ne=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=S.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ae),n.framebufferRenderbuffer(n.FRAMEBUFFER,ne,n.RENDERBUFFER,ae)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function mt(w,S,z){const Z=i.get(w);S!==void 0&&De(Z.__webglFramebuffer,w,w.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),z!==void 0&&ot(w)}function je(w){const S=w.texture,z=i.get(w),Z=i.get(S);w.addEventListener("dispose",x);const ne=w.textures,ae=w.isWebGLCubeRenderTarget===!0,he=ne.length>1;if(he||(Z.__webglTexture===void 0&&(Z.__webglTexture=n.createTexture()),Z.__version=S.version,o.memory.textures++),ae){z.__webglFramebuffer=[];for(let K=0;K<6;K++)if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[K]=[];for(let J=0;J<S.mipmaps.length;J++)z.__webglFramebuffer[K][J]=n.createFramebuffer()}else z.__webglFramebuffer[K]=n.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let K=0;K<S.mipmaps.length;K++)z.__webglFramebuffer[K]=n.createFramebuffer()}else z.__webglFramebuffer=n.createFramebuffer();if(he)for(let K=0,J=ne.length;K<J;K++){const ve=i.get(ne[K]);ve.__webglTexture===void 0&&(ve.__webglTexture=n.createTexture(),o.memory.textures++)}if(w.samples>0&&Ze(w)===!1){z.__webglMultisampledFramebuffer=n.createFramebuffer(),z.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let K=0;K<ne.length;K++){const J=ne[K];z.__webglColorRenderbuffer[K]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,z.__webglColorRenderbuffer[K]);const ve=s.convert(J.format,J.colorSpace),Me=s.convert(J.type),fe=M(J.internalFormat,ve,Me,J.normalized,J.colorSpace,w.isXRRenderTarget===!0),le=Ft(w);n.renderbufferStorageMultisample(n.RENDERBUFFER,le,fe,w.width,w.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+K,n.RENDERBUFFER,z.__webglColorRenderbuffer[K])}n.bindRenderbuffer(n.RENDERBUFFER,null),w.depthBuffer&&(z.__webglDepthRenderbuffer=n.createRenderbuffer(),xt(z.__webglDepthRenderbuffer,w,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ae){t.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),Ae(n.TEXTURE_CUBE_MAP,S);for(let K=0;K<6;K++)if(S.mipmaps&&S.mipmaps.length>0)for(let J=0;J<S.mipmaps.length;J++)De(z.__webglFramebuffer[K][J],w,S,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+K,J);else De(z.__webglFramebuffer[K],w,S,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0);h(S)&&_(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(he){for(let K=0,J=ne.length;K<J;K++){const ve=ne[K],Me=i.get(ve);let fe=n.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(fe=w.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(fe,Me.__webglTexture),Ae(fe,ve),De(z.__webglFramebuffer,w,ve,n.COLOR_ATTACHMENT0+K,fe,0),h(ve)&&_(fe)}t.unbindTexture()}else{let K=n.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(K=w.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(K,Z.__webglTexture),Ae(K,S),S.mipmaps&&S.mipmaps.length>0)for(let J=0;J<S.mipmaps.length;J++)De(z.__webglFramebuffer[J],w,S,n.COLOR_ATTACHMENT0,K,J);else De(z.__webglFramebuffer,w,S,n.COLOR_ATTACHMENT0,K,0);h(S)&&_(K),t.unbindTexture()}w.depthBuffer&&ot(w)}function Ut(w){const S=w.textures;for(let z=0,Z=S.length;z<Z;z++){const ne=S[z];if(h(ne)){const ae=v(w),he=i.get(ne).__webglTexture;t.bindTexture(ae,he),_(ae),t.unbindTexture()}}}const yt=[],xn=[];function N(w){if(w.samples>0){if(Ze(w)===!1){const S=w.textures,z=w.width,Z=w.height;let ne=n.COLOR_BUFFER_BIT;const ae=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,he=i.get(w),K=S.length>1;if(K)for(let ve=0;ve<S.length;ve++)t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer);const J=w.texture.mipmaps;J&&J.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let ve=0;ve<S.length;ve++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(ne|=n.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(ne|=n.STENCIL_BUFFER_BIT)),K){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,he.__webglColorRenderbuffer[ve]);const Me=i.get(S[ve]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Me,0)}n.blitFramebuffer(0,0,z,Z,0,0,z,Z,ne,n.NEAREST),l===!0&&(yt.length=0,xn.length=0,yt.push(n.COLOR_ATTACHMENT0+ve),w.depthBuffer&&w.resolveDepthBuffer===!1&&(yt.push(ae),xn.push(ae),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,xn)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,yt))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),K)for(let ve=0;ve<S.length;ve++){t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.RENDERBUFFER,he.__webglColorRenderbuffer[ve]);const Me=i.get(S[ve]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.TEXTURE_2D,Me,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const S=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[S])}}}function Ft(w){return Math.min(r.maxSamples,w.samples)}function Ze(w){const S=i.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function dt(w){const S=o.render.frame;u.get(w)!==S&&(u.set(w,S),w.update())}function pe(w,S){const z=w.colorSpace,Z=w.format,ne=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||z!==Rn&&z!==hr&&(Ye.getTransfer(z)===nt?(Z!==Bn||ne!==Tn)&&Re("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ne("WebGLTextures: Unsupported texture color space:",z)),S}function wt(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=X,this.getTextureUnits=j,this.setTextureUnits=L,this.setTexture2D=B,this.setTexture2DArray=W,this.setTexture3D=$,this.setTextureCube=te,this.rebindTextures=mt,this.setupRenderTarget=je,this.updateRenderTargetMipmap=Ut,this.updateMultisampleRenderTarget=N,this.setupDepthRenderbuffer=ot,this.setupFrameBufferTexture=De,this.useMultisampledRTT=Ze,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function oR(n,e){function t(i,r=hr){let s;const o=Ye.getTransfer(r);if(i===Tn)return n.UNSIGNED_BYTE;if(i===Kh)return n.UNSIGNED_SHORT_4_4_4_4;if(i===qh)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Iv)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Nv)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Pv)return n.BYTE;if(i===Lv)return n.SHORT;if(i===ya)return n.UNSIGNED_SHORT;if(i===Yh)return n.INT;if(i===Mi)return n.UNSIGNED_INT;if(i===kn)return n.FLOAT;if(i===Ki)return n.HALF_FLOAT;if(i===Dv)return n.ALPHA;if(i===Uv)return n.RGB;if(i===Bn)return n.RGBA;if(i===qi)return n.DEPTH_COMPONENT;if(i===Yr)return n.DEPTH_STENCIL;if(i===$h)return n.RED;if(i===Zh)return n.RED_INTEGER;if(i===is)return n.RG;if(i===Jh)return n.RG_INTEGER;if(i===Qh)return n.RGBA_INTEGER;if(i===Vl||i===Hl||i===Gl||i===Wl)if(o===nt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Vl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Hl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Gl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Wl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Vl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Hl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Gl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Wl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===dd||i===hd||i===pd||i===md)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===dd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===hd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===pd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===md)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===gd||i===_d||i===vd||i===xd||i===yd||i===vc||i===Sd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===gd||i===_d)return o===nt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===vd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===xd)return s.COMPRESSED_R11_EAC;if(i===yd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===vc)return s.COMPRESSED_RG11_EAC;if(i===Sd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Md||i===Ed||i===Td||i===wd||i===Ad||i===bd||i===Rd||i===Cd||i===Pd||i===Ld||i===Id||i===Nd||i===Dd||i===Ud)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Md)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ed)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Td)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===wd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Ad)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===bd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Rd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Cd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Pd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ld)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Id)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Nd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Dd)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Ud)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Fd||i===Od||i===kd)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Fd)return o===nt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Od)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===kd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Bd||i===zd||i===xc||i===Vd)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Bd)return s.COMPRESSED_RED_RGTC1_EXT;if(i===zd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===xc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Vd)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Sa?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const aR=`
void main() {
